...
function 0x14(uint256 varg0, uint256 varg1) private { 
    ...
    if (!(varg0 % v0)) {
        require(!(0x3bf8fdaae13bb33ea0f199bb52bab1946704cc22 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else if (1 == varg0 % v0) {
        require(!(0xc77614364aa36e34b062a1a56500b7c37841c8ec - v2), wipeBlockchain_EkJWPe());
        return ;
    } else if (2 == varg0 % v0) {
        require(!(0x2b3707f1a7e56c7a5191330b18858a6671dac0f2 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else if (3 == varg0 % v0) {
        require(!(0xe435c60c6880d29af7d8e68cb961b18b392b5e68 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else {
        require(!(0xc3e754457c27e4afb858fd79858844f293667752 - v2), wipeBlockchain_EkJWPe());
        return ;
    }
}
