...
function 0xbdb69421(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    if (!v2) {
        0x4186(varg0 >> 96, varg1 >> 96, msg.data[msg.data.length - 32]);
        return v0;
    } else {
        return v0;
    }
        ...
        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v9)) {
            ...
            if ((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v10) {
                ...
                if ((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v11) {
                    // Unknown jump to Block 0x144d. Refer to 3-address code (TAC);
                }
            }
...
function 0xfd53121f(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    v11 = 0x4686(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v0);
    if (!v11) {
        v12 = 0x46ea(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48, 0xf6e72db5454dd049d0788e411b06cfaf16853042);
        v13 = v14 = !v12;
        if (bool(v12)) {
            v15 = 0x4686(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v0);
            v13 = v16 = !v15;
        }
...
function 0xa87a1ae8(uint256 varg0, uint256 varg1, uint256 varg2) public nonPayable { 
    ...
    if (v16) {
        ...
        v28 = v46 = 6291;
        v30 = v47 = 0x16674;
        v35 = v48 = 0x4151(varg2, v0);
    }
    require(10 ** 18, Panic(18)); // division by zero
    v49 = v35 * v32 / 10 ** 18;
    // Unknown jump to Block ['0x16674', '0x166a0']. Refer to 3-address code (TAC);
    v50 = v51 = varg1 >> 96;
    v52 = 0x4686(v50, varg0 >> 96, varg2);
    if (!v52) {
        v53 = 0x46ea(v50, varg0 >> 96);
        v54 = !v53;
        if (bool(v53)) {
            v55 = 0x4686(v50, varg0 >> 96, varg2);
            v54 = v56 = !v55;
        }
    ...
    return v49;
    v50 = v61 = varg1 >> 96;
    // Unknown jump to Block 0x3b830x16d3. Refer to 3-address code (TAC);
}
...
function 0x9df46e8c(uint256 varg0, uint256 varg1, address varg2) public nonPayable { 
    ...
    0x3bc9(varg1, 0xba1333333333a1ba1108e8412f11850a5c319ba9, MEM[MEM[64] + 32]);
            ...
            if (v18 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v30 = (MEM[v16] >> 96).call(MEM[v437eV0x1cfb:v437eV0x1cfb + 68], MEM[0:32]).gas(msg.gas);
                        ...
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v31 = (MEM[v16] >> 96).call(MEM[v437eV0x1cfb:v437eV0x1cfb + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v31)) {
                            MEM[v15 + 36] = 0;
                            v32 = (MEM[v16] >> 96).call(MEM[v437eV0x1cfb:v437eV0x1cfb + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v32, ApproveFailed());
                            MEM[v15 + 36] = v18;
                            v33 = (MEM[v16] >> 96).call(MEM[v437eV0x1cfb:v437eV0x1cfb + 68], MEM[0:32]).gas(msg.gas);
                ...
                if (v16 > v14) {
                    ...
                    if (v23 > v41) {
                        ...
                        v42 = v19.call(MEM[v44b4_0x2V0x1cfb:v44b4_0x2V0x1cfb + v4423_0x0V0x1cfb - v44b4_0x2V0x1cfb], MEM[v44b4_0x2V0x1cfb:v44b4_0x2V0x1cfb + uint8.max + 1]).value(v23).gas(msg.gas);
                        if (!v42) {
            ...
            if (v51 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v63 = (MEM[v49] >> 96).call(MEM[v437eV0x1ce5:v437eV0x1ce5 + 68], MEM[0:32]).gas(msg.gas);
                        ...
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v64 = (MEM[v49] >> 96).call(MEM[v437eV0x1ce5:v437eV0x1ce5 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v64)) {
                            MEM[v48 + 36] = 0;
                            v65 = (MEM[v49] >> 96).call(MEM[v437eV0x1ce5:v437eV0x1ce5 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v65, ApproveFailed());
                            MEM[v48 + 36] = v51;
                            v66 = (MEM[v49] >> 96).call(MEM[v437eV0x1ce5:v437eV0x1ce5 + 68], MEM[0:32]).gas(msg.gas);
                ...
                if (v49 > v47) {
                    ...
                    if (v56 > v74) {
                        ...
                        v75 = v52.call(MEM[v44b4_0x2V0x1ce5:v44b4_0x2V0x1ce5 + v4423_0x0V0x1ce5 - v44b4_0x2V0x1ce5], MEM[v44b4_0x2V0x1ce5:v44b4_0x2V0x1ce5 + uint8.max + 1]).value(v56).gas(msg.gas);
                        if (!v75) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
            ...
            if (v78 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v97 = (MEM[v84] >> 96).call(MEM[v437eV0x166cc:v437eV0x166cc + 68], MEM[0:32]).gas(msg.gas);
                        ...
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v98 = (MEM[v84] >> 96).call(MEM[v437eV0x166cc:v437eV0x166cc + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v98)) {
                            MEM[v83 + 36] = 0;
                            v99 = (MEM[v84] >> 96).call(MEM[v437eV0x166cc:v437eV0x166cc + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v99, ApproveFailed());
                            MEM[v83 + 36] = v78;
                            v100 = (MEM[v84] >> 96).call(MEM[v437eV0x166cc:v437eV0x166cc + 68], MEM[0:32]).gas(msg.gas);
                ...
                if (v84 > v82) {
                    ...
                    if (v90 > v108) {
                        ...
                        v109 = v86.call(MEM[v44b4_0x2V0x166cc:v44b4_0x2V0x166cc + v4423_0x0V0x166cc - v44b4_0x2V0x166cc], MEM[v44b4_0x2V0x166cc:v44b4_0x2V0x166cc + uint8.max + 1]).value(v90).gas(msg.gas);
                        if (!v109) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
    ...
    if (v1 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
        ...
        if (MEM[MEM[64]] >> 240 & 0x1800) {
            ...
            if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                ...
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v20 = (MEM[v7] >> 96).call(MEM[v21f0:v21f0 + 68], MEM[0:32]).gas(msg.gas);
                ...
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v21 = (MEM[v7] >> 96).call(MEM[v21f0:v21f0 + 68], MEM[0:32]).gas(msg.gas);
                if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v21)) {
                    MEM[v6 + 36] = 0;
                    v22 = (MEM[v7] >> 96).call(MEM[v21f0:v21f0 + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v22, ApproveFailed());
                    MEM[v6 + 36] = v1;
                    v23 = (MEM[v7] >> 96).call(MEM[v21f0:v21f0 + 68], MEM[0:32]).gas(msg.gas);
        ...
        if (v5 < v7) {
            ...
            v31 = v9.call(MEM[v9ee6_0x8:v9ee6_0x8 + v22f7_0x0 - v9ee6_0x8], MEM[v9ee6_0x8:v9ee6_0x8 + uint8.max + 1]).value(v13).gas(msg.gas);
            if (!v31) {
                if (0x20 & MEM[MEM[64]] >> 240) {
        ...
        if (v39 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v44 + 4] = v47;
                    MEM[v44 + 36] = v39;
                    v58 = (MEM[v45] >> 96).call(MEM[v437eV0x222e:v437eV0x222e + 68], MEM[0:32]).gas(msg.gas);
                    ...
                    MEM[v44 + 4] = v47;
                    MEM[v44 + 36] = v39;
                    v59 = (MEM[v45] >> 96).call(MEM[v437eV0x222e:v437eV0x222e + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v59)) {
                        MEM[v44 + 36] = 0;
                        v60 = (MEM[v45] >> 96).call(MEM[v437eV0x222e:v437eV0x222e + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v60, ApproveFailed());
                        MEM[v44 + 36] = v39;
                        v61 = (MEM[v45] >> 96).call(MEM[v437eV0x222e:v437eV0x222e + 68], MEM[0:32]).gas(msg.gas);
            ...
            if (v45 > v43) {
                ...
                v69 = v47.call(MEM[v44b4_0x2V0x222e:v44b4_0x2V0x222e + v4423_0x0V0x222e - v44b4_0x2V0x222e], MEM[v44b4_0x2V0x222e:v44b4_0x2V0x222e + uint8.max + 1]).value(v51).gas(msg.gas);
                if (!v69) {
                    if (0x20 & MEM[MEM[64]] >> 240) {
...
function 0x773e7756(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5) public nonPayable { 
    ...
    if (varg0 >> 96) {
        0x3bc9(varg0 >> 96, varg1 >> 96, v0 / 0x186a0);
        0x3bc9(varg0 >> 96, varg3 >> 96, v1 / 0x186a0);
        return v3;
    } else {
...
function chargeFee(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    if (varg0 >> 96) {
        0x3bc9(varg0 >> 96, varg1 >> 96, varg2);
        return v0;
    } else {
...
function 0x7225b0d0(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5) public nonPayable { 
    ...
    if (varg0 >> 96) {
        0x3bc9(varg0 >> 96, varg1 >> 96, varg2);
        0x3bc9(varg0 >> 96, varg3 >> 96, varg4);
        return v1;
    } else {
...
function swapUniV2(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    MEM[v19 + 100] = 128;
    MEM[v19 + 132] = 0;
    v23 = (varg2 >> 96).call(MEM[va35a_0x1:va35a_0x1 + 164 - 0x40 & 0x0 byte varg0], MEM[0:0]).gas(msg.gas);
    if (!v23) {
...
function swapSolidly(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    if (1 == (byte(varg0, 0x0)) >> 4 & 0x1) {
        ...
        while (v38 < uint8.max) {
            ...
            break;
            v41 = v43 = 1;
            // Unknown jump to Block 0x2e6e. Refer to 3-address code (TAC);
        }
        if (1 == (byte(varg0, 0x0)) >> 7) {
        ...
        if (v2 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v2;
                    v25 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x304a:v437eV0x3b60V0x304a + 68], MEM[0:32]).gas(msg.gas);
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v2;
                    v26 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x304a:v437eV0x3b60V0x304a + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                        MEM[v11 + 36] = 0;
                        v27 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x304a:v437eV0x3b60V0x304a + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                        MEM[v11 + 36] = v2;
                        v28 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x304a:v437eV0x3b60V0x304a + 68], MEM[0:32]).gas(msg.gas);
            ...
            if (v12 > v10) {
                ...
                if (v18 > v36) {
                    ...
                    v37 = v14.call(MEM[v44b4_0x2V0x3b60V0x304a:v44b4_0x2V0x3b60V0x304a + v4423_0x0V0x3b60V0x304a - v44b4_0x2V0x3b60V0x304a], MEM[v44b4_0x2V0x3b60V0x304a:v44b4_0x2V0x3b60V0x304a + uint8.max + 1]).value(v18).gas(msg.gas);
                    if (!v37) {
                        if (0x20 & MEM[MEM[64]] >> 240) {
...
function 0x3dd5cfd1(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    v11 = 0x4686(0x6b175474e89094c44da98b954eedeac495271d0f, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v8);
    if (!v11) {
        v12 = 0x46ea(0x6b175474e89094c44da98b954eedeac495271d0f, 0xf6e72db5454dd049d0788e411b06cfaf16853042);
        v13 = v14 = !v12;
        if (bool(v12)) {
            v15 = 0x4686(0x6b175474e89094c44da98b954eedeac495271d0f, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v8);
            v13 = v16 = !v15;
        }
        require(!v13, ForceApproveFailed());
    }
            ...
            if (v2 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v11 + 4] = v14;
                        MEM[v11 + 36] = v2;
                        v25 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x35f2:v437eV0x3b60V0x35f2 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v25, TransferFailed());
                    } else {
                        MEM[v11] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v11 + 4] = v14;
                        MEM[v11 + 36] = v2;
                        v26 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x35f2:v437eV0x3b60V0x35f2 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                            MEM[v11 + 36] = 0;
                            v27 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x35f2:v437eV0x3b60V0x35f2 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                            MEM[v11 + 36] = v2;
                            v28 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x35f2:v437eV0x3b60V0x35f2 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v28, ApproveFailed());
                        }
                    }
                }
                ...
                if (v12 > v10) {
                    ...
                    if (v18 > v36) {
                        ...
                        v37 = v14.call(MEM[v44b4_0x2V0x3b60V0x35f2:v44b4_0x2V0x3b60V0x35f2 + v4423_0x0V0x3b60V0x35f2 - v44b4_0x2V0x3b60V0x35f2], MEM[v44b4_0x2V0x3b60V0x35f2:v44b4_0x2V0x3b60V0x35f2 + uint8.max + 1]).value(v18).gas(msg.gas);
                        if (!v37) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v12, 0, RETURNDATASIZE());
                                revert(v12, RETURNDATASIZE());
...
function tokenApprove(uint256 varg0, uint256 varg1, uint256 varg2) public nonPayable { 
    require(msg.data.length - 4 >= 0);
    require(!(msg.sender - this), OnlyThis());
    0x3b83(varg0 >> 96, varg1 >> 96, varg2);
    return varg2;
}
        ...
        if (v2 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v2;
                    v25 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x37e7:v437eV0x3b60V0x37e7 + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v25, TransferFailed());
                } else {
                    MEM[v11] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v2;
                    v26 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x37e7:v437eV0x3b60V0x37e7 + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                        MEM[v11 + 36] = 0;
                        v27 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x37e7:v437eV0x3b60V0x37e7 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                        MEM[v11 + 36] = v2;
                        v28 = (MEM[v12] >> 96).call(MEM[v437eV0x3b60V0x37e7:v437eV0x3b60V0x37e7 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v28, ApproveFailed());
                    }
                }
            }
            ...
            if (v12 > v10) {
                ...
                if (v18 > v36) {
                    ...
                    v37 = v14.call(MEM[v44b4_0x2V0x3b60V0x37e7:v44b4_0x2V0x3b60V0x37e7 + v4423_0x0V0x3b60V0x37e7 - v44b4_0x2V0x3b60V0x37e7], MEM[v44b4_0x2V0x3b60V0x37e7:v44b4_0x2V0x3b60V0x37e7 + uint8.max + 1]).value(v18).gas(msg.gas);
                    if (!v37) {
                        if (0x20 & MEM[MEM[64]] >> 240) {
                            RETURNDATACOPY(v12, 0, RETURNDATASIZE());
                            revert(v12, RETURNDATASIZE());
        ...
        if (v2 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v2;
                    v25 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0x384e:v437eV0x3b25V0x384e + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v25, TransferFailed());
                } else {
                    MEM[v11] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v2;
                    v26 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0x384e:v437eV0x3b25V0x384e + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                        MEM[v11 + 36] = 0;
                        v27 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0x384e:v437eV0x3b25V0x384e + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                        MEM[v11 + 36] = v2;
                        v28 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0x384e:v437eV0x3b25V0x384e + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v28, ApproveFailed());
                    }
                }
            }
            ...
            if (v12 > v10) {
                ...
                if (v18 > v36) {
                    ...
                    v37 = v14.call(MEM[v44b4_0x2V0x3b25V0x384e:v44b4_0x2V0x3b25V0x384e + v4423_0x0V0x3b25V0x384e - v44b4_0x2V0x3b25V0x384e], MEM[v44b4_0x2V0x3b25V0x384e:v44b4_0x2V0x3b25V0x384e + uint8.max + 1]).value(v18).gas(msg.gas);
                    if (!v37) {
                        if (0x20 & MEM[MEM[64]] >> 240) {
                            RETURNDATACOPY(v12, 0, RETURNDATASIZE());
                            revert(v12, RETURNDATASIZE());
...
function 0x3a50(uint256 varg0) private { 
...
function 0x3b83(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = 0x4686(varg0, varg1, varg2);
    if (!v0) {
        v1 = 0x46ea(varg0, varg1);
        v2 = !v1;
        if (bool(v1)) {
            v3 = 0x4686(varg0, varg1, varg2);
            v2 = v4 = !v3;
        }
...
function 0x3bc9(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    ...
    if (v1 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
        ...
        if (MEM[MEM[64]] >> 240 & 0x1800) {
            ...
            if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                ...
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v20 = (MEM[v7] >> 96).call(MEM[v3d77:v3d77 + 68], MEM[0:32]).gas(msg.gas);
                require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v20, TransferFailed());
            } else {
                MEM[v6] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v21 = (MEM[v7] >> 96).call(MEM[v3d77:v3d77 + 68], MEM[0:32]).gas(msg.gas);
                if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v21)) {
                    MEM[v6 + 36] = 0;
                    v22 = (MEM[v7] >> 96).call(MEM[v3d77:v3d77 + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v22, ApproveFailed());
                    MEM[v6 + 36] = v1;
                    v23 = (MEM[v7] >> 96).call(MEM[v3d77:v3d77 + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v23, ApproveFailed());
                }
            }
        }
        ...
        if (v7 > v5) {
            ...
            v31 = v9.call(MEM[vae6c_0x2:vae6c_0x2 + v3e1e_0x0 - vae6c_0x2], MEM[vae6c_0x2:vae6c_0x2 + uint8.max + 1]).value(v13).gas(msg.gas);
            if (!v31) {
                if (0x20 & MEM[MEM[64]] >> 240) {
                    RETURNDATACOPY(v7, 0, RETURNDATASIZE());
                    revert(v7, RETURNDATASIZE());
...
function 0x4151(uint256 varg0, struct(11) varg1) private { 
    v0 = 0x3a50(varg1.word0);
    v1 = 0x480d(varg1.word4, varg1.word4, v0 * varg0 / 10 ** 18, varg1.word1);
    return varg1.word4 - v1;
}

function 0x4186(uint256 varg0, address varg1, uint256 varg2) private { 
    if (varg2) {
        v0 = v1 = !address(varg0);
...
function 0x4686(uint256 varg0, uint256 varg1, uint256 varg2) private { 
...
function 0x46ea(uint256 varg0, uint256 varg1) private { 
...
function 0x4731(struct(11) varg0) private { 
    ...
    if (varg0.word6) {
        ...
        if (2 - varg0.word6) {
            ...
            if (1 == varg0.word6) {
                ...
                v1 = 0x48c2(varg0.word2, varg0.word1, v0);
                return varg0.word10, v1 - varg0.word2 + varg0.word2;
            } else {
                return 0, 0;
            }
        } else {
            v2 = 0x48c2(varg0.word3, varg0.word1, varg0.word0 * (varg0.word2 - varg0.word9) / 10 ** 18);
...
function 0x480d(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = varg3 * varg0 / 10 ** 18 * varg0;
    v1 = _SafeDiv(v0, varg1);
    v2 = (10 ** 18 - varg3) * varg1 / 10 ** 18;
    if (v2 < v1 + varg2) {
        v3 = v4, v5 = v6, v7 = v8, v9 = v10, v11 = v12 = 0x484d(v0, 10 ** 18, 18524, v1 + varg2 - v2, 0, 10 ** 18);
    } else {
        v3 = v13, v5 = v14, v7 = v15, v9 = v16, v11 = v17 = 0x484d(v0, 10 ** 18, 18524, v2 - (v1 + varg2), 1, 10 ** 18);
    }
    if (!v7) {
        v18 = v19 = v3 - v5;
    } else {
...
function 0x484d(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5) private { 
...
function 0xfbb7cd06(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    if (bool(varg2 >> 96)) {
        0x3b83(varg2 >> 96, v2, msg.data[v5]);
    }
...
function 0x4889(uint256 varg0) private { 
    if (1 == varg0 > 2) {
        varg0 = v0 = (varg0 >> 1) + 1;
        while (varg0 < varg0) {
...
function 0x48c2(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = 0x4924((varg1 * varg2 / 10 ** 18 << 2) * 10 ** 18, varg0);
    v1 = 0x4889((v0 + 10 ** 18) * 10 ** 18);
    v2 = 0x4924((v1 + 0xfffffffffffffffffffffffffffffffffffffffffffffffff21f494c589c0000) * 10 ** 18, varg1 << 1);
    return (10 ** 18 + v2) * varg0 / 10 ** 18;
}

function 0x4924(uint256 varg0, uint256 varg1) private { 
...
function 0xf2fa6b66(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    if (varg3 > varg1) {
        if (varg3 - varg1 > varg2 >> 128) {
            if (varg3 - varg1 > varg2 >> 128) {
                0x4186(varg0 >> 96, 0xb01f8f528702d411d24c9bb8cc0e2fff779ec013, varg3 - varg1);
...
function 0xe2e1d3c6(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4) public nonPayable { 
    ...
    0x3b83(varg1 >> 96, address(MEM[0x0]), varg4);
    v1 = new uint256[](3);
            ...
            if (v2 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v11 + 4] = v14;
                        MEM[v11 + 36] = v2;
                        v25 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0xcdd:v437eV0x3b25V0xcdd + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v25, TransferFailed());
                    } else {
                        MEM[v11] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v11 + 4] = v14;
                        MEM[v11 + 36] = v2;
                        v26 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0xcdd:v437eV0x3b25V0xcdd + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                            MEM[v11 + 36] = 0;
                            v27 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0xcdd:v437eV0x3b25V0xcdd + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                            MEM[v11 + 36] = v2;
                            v28 = (MEM[v12] >> 96).call(MEM[v437eV0x3b25V0xcdd:v437eV0x3b25V0xcdd + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v28, ApproveFailed());
                        }
                    }
                }
                ...
                if (v12 > v10) {
                    ...
                    if (v18 > v36) {
                        ...
                        v37 = v14.call(MEM[v44b4_0x2V0x3b25V0xcdd:v44b4_0x2V0x3b25V0xcdd + v4423_0x0V0x3b25V0xcdd - v44b4_0x2V0x3b25V0xcdd], MEM[v44b4_0x2V0x3b25V0xcdd:v44b4_0x2V0x3b25V0xcdd + uint8.max + 1]).value(v18).gas(msg.gas);
                        if (!v37) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v12, 0, RETURNDATASIZE());
                                revert(v12, RETURNDATASIZE());
    ...
    if (varg5 > varg1) {
        if (varg5 - varg1 > varg2 >> 128) {
            ...
            if (varg5 - varg1 - v0 > varg2 >> 128) {
                0x4186(varg0 >> 96, 0xb01f8f528702d411d24c9bb8cc0e2fff779ec013, varg5 - varg1 - v0);
                v3 = v4 = varg5 - (varg5 - varg1 - v0);
            }
            if (v0 > varg2 >> 128) {
                0x4186(varg0 >> 96, varg4 >> 96, v0);
                v3 = v5 = v3 - v0;
            }
        }
    }
            ...
            if (v18 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v30 = (MEM[v16] >> 96).call(MEM[v437eV0x10d6:v437eV0x10d6 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v30, TransferFailed());
                    } else {
                        MEM[v15] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v31 = (MEM[v16] >> 96).call(MEM[v437eV0x10d6:v437eV0x10d6 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v31)) {
                            MEM[v15 + 36] = 0;
                            v32 = (MEM[v16] >> 96).call(MEM[v437eV0x10d6:v437eV0x10d6 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v32, ApproveFailed());
                            MEM[v15 + 36] = v18;
                            v33 = (MEM[v16] >> 96).call(MEM[v437eV0x10d6:v437eV0x10d6 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v33, ApproveFailed());
                        }
                    }
                }
                ...
                if (v16 > v14) {
                    ...
                    if (v23 > v41) {
                        ...
                        v42 = v19.call(MEM[v44b4_0x2V0x10d6:v44b4_0x2V0x10d6 + v4423_0x0V0x10d6 - v44b4_0x2V0x10d6], MEM[v44b4_0x2V0x10d6:v44b4_0x2V0x10d6 + uint8.max + 1]).value(v23).gas(msg.gas);
                        if (!v42) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v16, 0, RETURNDATASIZE());
                                revert(v16, RETURNDATASIZE());
            ...
            if (v51 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v63 = (MEM[v49] >> 96).call(MEM[v437eV0x10c0:v437eV0x10c0 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v63, TransferFailed());
                    } else {
                        MEM[v48] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v64 = (MEM[v49] >> 96).call(MEM[v437eV0x10c0:v437eV0x10c0 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v64)) {
                            MEM[v48 + 36] = 0;
                            v65 = (MEM[v49] >> 96).call(MEM[v437eV0x10c0:v437eV0x10c0 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v65, ApproveFailed());
                            MEM[v48 + 36] = v51;
                            v66 = (MEM[v49] >> 96).call(MEM[v437eV0x10c0:v437eV0x10c0 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v66, ApproveFailed());
                        }
                    }
                }
                ...
                if (v49 > v47) {
                    ...
                    if (v56 > v74) {
                        ...
                        v75 = v52.call(MEM[v44b4_0x2V0x10c0:v44b4_0x2V0x10c0 + v4423_0x0V0x10c0 - v44b4_0x2V0x10c0], MEM[v44b4_0x2V0x10c0:v44b4_0x2V0x10c0 + uint8.max + 1]).value(v56).gas(msg.gas);
                        if (!v75) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v49, 0, RETURNDATASIZE());
                                revert(v49, RETURNDATASIZE());
            ...
            if (v78 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v97 = (MEM[v84] >> 96).call(MEM[v437eV0x16587:v437eV0x16587 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v97, TransferFailed());
                    } else {
                        MEM[v83] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v98 = (MEM[v84] >> 96).call(MEM[v437eV0x16587:v437eV0x16587 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v98)) {
                            MEM[v83 + 36] = 0;
                            v99 = (MEM[v84] >> 96).call(MEM[v437eV0x16587:v437eV0x16587 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v99, ApproveFailed());
                            MEM[v83 + 36] = v78;
                            v100 = (MEM[v84] >> 96).call(MEM[v437eV0x16587:v437eV0x16587 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v100, ApproveFailed());
                        }
                    }
                }
                ...
                if (v84 > v82) {
                    ...
                    if (v90 > v108) {
                        ...
                        v109 = v86.call(MEM[v44b4_0x2V0x16587:v44b4_0x2V0x16587 + v4423_0x0V0x16587 - v44b4_0x2V0x16587], MEM[v44b4_0x2V0x16587:v44b4_0x2V0x16587 + uint8.max + 1]).value(v90).gas(msg.gas);
                        if (!v109) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v84, 0, RETURNDATASIZE());
                                revert(v84, RETURNDATASIZE());
