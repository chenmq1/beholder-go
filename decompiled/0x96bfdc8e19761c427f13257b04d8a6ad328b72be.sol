...
function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes data) public nonPayable { 
    ...
    if (msg.data[4 + data]) {
        ...
        if (uint8(data.word1)) {
            if (uint8(data.word1) - 1) {
                ...
                if (uint8(data.word1) - 5) {
                    ...
                    v1, v2 = 0x3075(4 + data + 32, msg.data[4 + data], msg.data[4 + data]);
                ...
                v11 = v13 = 64;
                v14 = v15 = 3366;
                v16, v17 = 0x3075(4 + data + 32, msg.data[4 + data], msg.data[4 + data]);
            ...
            v19 = v21 = 3212;
            v11 = v22 = 64;
            v23, v24 = 0x3075(4 + data + 32, msg.data[4 + data], msg.data[4 + data]);
        ...
        MEM[v33 + 164] = 0;
        v34 = v35 = v33 + 196;
        v36 = address(v11).call(MEM[v1369d0x1d1_0x1:v1369d0x1d1_0x1 + v1649V0x331bV0x13703 - v1369d0x1d1_0x1], MEM[v1369d0x1d1_0x1:v1369d0x1d1_0x1 + v3b8bV0xd08]).value(v11).gas(msg.gas);
        if (v36) {
            if (v36) {
                v37 = v38 = 64;
        ...
        // Unknown jump to Block 0x31e30x1d1. Refer to 3-address code (TAC);
    } else if (amount0Delta <= 0) {
        0x3eaa(msg.sender, amount1Delta);
        exit;
    } else {
        0x3eaa(msg.sender, amount0Delta);
        exit;
    }
}
...
function 0xaf4cf912(uint256 varg0, uint256 varg1, int24 varg2, uint256 varg3, uint256 varg4, int24 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10, uint256 varg11, uint256 varg12) public payable { 
    ...
    if (!v0) {
        ...
        if (!varg0) {
            if (address(varg1) >= 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2) {
                v9 = v10 = 0x1550f;
                v11, v12, v13 = v14, v5 = v15 = 0x2a0e(varg1, 0x1558e, 0x15563, 0x15538);
                v16 = v17 = uint24(v11);
                v18 = v19 = 9719;
                v20 = v21 = 0x2ac3();
            } else {
                v9 = v22 = 0x15469;
                MEM[0] = MEM[0];
                v23, v24, v13 = v25, v5 = v26 = 0x2a0e(0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2, 0x154e8, 0x154bd, 0x15492);
                v16 = v27 = uint24(v23);
                v18 = v28 = 9719;
                v20 = v29 = 0x2ac3();
            }
        ...
        while (1) {
            ...
            // Unknown jump to Block ['0x1496c', '0x14a12', '0x1536f', '0x15492', '0x15538']. Refer to 3-address code (TAC);
            ...
            v36 = v38 = 9820;
            v39 = new struct(3);
            v39.word1 = keccak256(MEM[v2634_0x0.word2:v2634_0x0.word2 + 160]);
            v39.word2 = 6;
            v39.word0 = 64;
            require(!((v39 + 96 > uint64.max) | (v39 + 96 < v39)), Panic(65)); // failed memory allocation (too much memory)
            v40 = v39.word0.length;
            v41 = v42 = keccak256(keccak256(MEM[v2634_0x0.word2:v2634_0x0.word2 + 160]), 6);
            v43 = v44 = MEM[64];
            ...
            if (!v45) {
                ...
                if (10 ** 6 - v62 > 10 ** 6) {
                    ...
                    // Unknown jump to Block ['0x14a68', '0x153c5']. Refer to 3-address code (TAC);
                ...
                // Unknown jump to Block ['0x2966', '0x29ce']. Refer to 3-address code (TAC);
                break;
                break;
                // Unknown jump to Block 0x26b2. Refer to 3-address code (TAC);
                ...
                require(v53 - v43 >= 32);
                v49 = v98 = MEM[v43];
                // Unknown jump to Block ['0x3695B0x2653', '0x36b2B0x2653']. Refer to 3-address code (TAC);
                break;
            }
            RETURNDATACOPY(MEM[64], 0, RETURNDATASIZE());
            ...
            MEM[v20 + 64] = uint24(v16);
            MEM[v20 + 96] = int24(v36);
            // Unknown jump to Block 0x14914. Refer to 3-address code (TAC);
            MEM[v20 + 64] = uint24(v16);
            MEM[v20 + 96] = int24(v36);
            // Unknown jump to Block 0x14914. Refer to 3-address code (TAC);
        }
        ...
        v101 = v102 = 9990;
        v103 = new struct(3);
        v103.word1 = keccak256(MEM[MEM[v26fd_0x3 + 64]:MEM[v26fd_0x3 + 64] + 160]);
        v103.word2 = 6;
        v103.word0 = 64;
        require(!((v103 + 96 > uint64.max) | (v103 + 96 < v103)), Panic(65)); // failed memory allocation (too much memory)
        v104 = v103.word0.length;
        v105 = v106 = keccak256(keccak256(MEM[MEM[v26fd_0x3 + 64]:MEM[v26fd_0x3 + 64] + 160]), 6);
        v107 = v108 = MEM[64];
        ...
        if (v109) {
            ...
            0x354e(v126);
            v127 = 0x356c(address(v126.word2));
            ...
            if (v130) {
                ...
                v134 = MEM[v128];
                // Unknown jump to Block ['0x43bc0x1ef', '0x8c50x1ef']. Refer to 3-address code (TAC);
                v139 = this.balance;
                ...
                if (!v144) {
                    ...
                    // Unknown jump to Block ['0x15e470x1ef', '0x15f340x1ef']. Refer to 3-address code (TAC);
                } else {
                    ...
                    if (this.balance <= v153 / 1000) {
                        MEM[0] = MEM[0];
                        v155 = 0x2b27(v134);
                        0x44ff(v155, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                    }
                    if (v153 / 1000) {
                ...
                if (v134 <= v159) {
                    ...
                    while (1) {
                        ...
                        if (uint96.max + 1 <= v170) {
                            ...
                            if (v162 * v5 % uint256.max - v169 == v162 * v5 % uint256.max < v169) {
                                v162 = v169 >> 96;
                                // Unknown jump to Block ['0x37010x1ef', '0x37060x1ef']. Refer to 3-address code (TAC);
                            } else {
                    ...
                    if (v162 <= v5) {
                        ...
                        v217 = v207.call(MEM[v1ef0x15de0:v1ef0x15de0 + v1649V0x331bV0x15e8f0x1ef - v1ef0x15de0], MEM[v1ef0x15de0:v1ef0x15de0 + v1ef0x37a6]).value(v206).gas(msg.gas);
                        if (v217) {
                            v5 = v218 = 0x15e47;
                            if (v217) {
                                if (64 > RETURNDATASIZE()) {
            ...
            v113 = v229 = MEM[v107];
            // Unknown jump to Block ['0x3695B0x26fd', '0x36b2B0x26fd']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x366eB0x26fd. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
        MEM[v20 + 64] = uint24(v16);
        MEM[v20 + 96] = int24(v36);
...
function unlockCallback(bytes rawData) public nonPayable { 
    ...
    if (uint8(rawData.word1) - 3) {
        if (uint8(rawData.word1) - 4) {
            if (uint8(rawData.word1) - 5) {
                ...
                v1 = v2 = 8225;
                v3, v4 = 0x3075(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
            ...
            v21, v22 = 0x3075(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
            ...
            if (!v25) {
                ...
                MEM[v33 + 4 + 288] = 0;
                v34 = v33 + 4 + 320;
                // Unknown jump to Block 0x1b04. Refer to 3-address code (TAC);
            } else {
                v30 = v35 = 32;
                v36 = 0x2ad2();
                v36.word0 = bool(v25);
            ...
            v39 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v1ac20x31aaV0x1f8e - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v1b04_0x3]).gas(msg.gas);
            if (v39) {
                v1 = v40 = 6975;
                v1 = v41 = 32;
                v1 = v42 = 7037;
        ...
        v1 = v49 = 5975;
        v50, v51 = 0x3075(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
    ...
    MEM[v19 + 288] = 0;
    // Unknown jump to Block ['0x1757', '0x17e3', '0x1b7d', '0x2021', '0x20ae', '0x2100']. Refer to 3-address code (TAC);
    v66 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v31740x1f9_0x1 + 320 - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v30b1V0x31ffV0x1fc0]).gas(msg.gas);
    if (v66) {
        v1 = v67 = 6034;
        v1 = v68 = 32;
        v1 = v69 = 6115;
    ...
    if (int128(v73) != int128.min) {
        v75 = 0 - int128(v73);
        // Unknown jump to Block ['0x1792', '0x1898', '0x1b3f', '0x205d', '0x20e9']. Refer to 3-address code (TAC);
        if (!v1) {
            MEM[0] = MEM[0];
            v16 = v76 = 0x2ad2();
            v76.word0 = bool(v1);
        ...
        if (address(MEM[v1])) {
            ...
            if (v85) {
                if (v85) {
                    // Unknown jump to Block 0x19ce. Refer to 3-address code (TAC);
                }
            }
        } else {
            MEM[0] = MEM[0];
    ...
    v73 = v117 = int128(v43);
    // Unknown jump to Block 0x31ad. Refer to 3-address code (TAC);
    ...
    require(v47 - v1 >= 32);
    v43 = MEM[v1];
    // Unknown jump to Block ['0x14815', '0x1489c', '0x196d', '0x19e6', '0x1a33', '0x1a6f', '0x1f55', '0x1f88', '0x23be']. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x1806. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x1783. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x1ba0. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x1b30. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x2123. Refer to 3-address code (TAC);
    v118 = new uint256[](MEM[96]);
    MCOPY(v118.data, 128, MEM[96]);
    MEM[32 + (MEM[96] + v118)] = 0;
    return v118;
    // Unknown jump to Block 0x1944. Refer to 3-address code (TAC);
    v119 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v31740x1f9_0x1 + 320 - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v30b1V0x31ffV0x1fc0]).gas(msg.gas);
    if (v119) {
        v43 = v120 = 0;
        if (v119) {
            v45 = v121 = 6707;
    ...
    v132 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v31740x1f9_0x1 + 320 - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v30b1V0x31ffV0x1fc0]).gas(msg.gas);
    if (v132) {
        v43 = v133 = 0;
        if (v132) {
            v45 = v134 = 8021;
    ...
    v169 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v31740x1f9_0x1 + 320 - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v30b1V0x31ffV0x1fc0]).gas(msg.gas);
    if (v169) {
        v1 = v170 = 8366;
        v1 = v171 = 32;
        v1 = v172 = 8285;
    ...
    v177 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v31740x1f9_0x1 + 320 - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v30b1V0x31ffV0x1fc0]).gas(msg.gas);
    if (v177) {
        v1 = v178 = 8448;
        v1 = v179 = 32;
        v1 = v180 = 8425;
    ...
    v186 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v31740x1f9_0x1 + 320 - v30b1V0x31ffV0x1fc0], MEM[v30b1V0x31ffV0x1fc0:v30b1V0x31ffV0x1fc0 + v30b1V0x31ffV0x1fc0]).gas(msg.gas);
    if (v186) {
        v43 = v187 = 0;
        if (v186) {
            v45 = v188 = 9150;
...
function 0x3a2daf8d(uint256 varg0, uint256 varg1, int24 varg2, uint256 varg3, uint256 varg4, uint256 varg5, int24 varg6, uint256 varg7, uint256 varg8, uint256 varg9, int24 varg10, uint256 varg11, uint256 varg12, uint256 varg13, uint256 varg14, uint256 varg15) public payable { 
    ...
    if (!v0) {
        ...
        if (!varg0) {
            if (address(varg1) >= 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2) {
                v4, v1 = v5 = 0x2f94(varg1, 0x15ab6);
                v6 = v7 = uint24(v4);
                v8 = v9 = 0x2ac3();
            } else {
                MEM[0] = MEM[0];
                v10 = 0x2b15(0xfffff & varg14 >> 88);
                v1 = v11 = 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2;
                v6 = v12 = uint24(v10);
                v8 = v13 = 0x2ac3();
            }
        } else {
            v14 = 0x2b15(0xfffff & varg14 >> 88);
            v6 = v15 = uint24(v14);
            v8 = v16 = 0x2ac3();
        }
        MEM[v8] = address(v1);
        ...
        v19 = v21 = 11481;
        v22 = new struct(3);
        v22.word1 = keccak256(MEM[v2cad_0x0V0x1523.word2:v2cad_0x0V0x1523.word2 + 160]);
        v22.word2 = 6;
        v22.word0 = 64;
        require(!((v22 + 96 > uint64.max) | (v22 + 96 < v22)), Panic(65)); // failed memory allocation (too much memory)
        v23 = v22.word0.length;
        v24 = v25 = keccak256(keccak256(MEM[v2cad_0x0V0x1523.word2:v2cad_0x0V0x1523.word2 + 160]), 6);
        v26 = v27 = MEM[64];
        ...
        if (v28) {
            ...
            v59 = new struct(3);
            v59.word1 = keccak256(MEM[v2d65_0x0V0x1523.word2:v2d65_0x0V0x1523.word2 + 160]);
            v59.word2 = 6;
            v59.word0 = 64;
            require(!((v59 + 96 > uint64.max) | (v59 + 96 < v59)), Panic(65)); // failed memory allocation (too much memory)
            v60 = v59.word0.length;
            v61 = v62 = keccak256(keccak256(MEM[v2d65_0x0V0x1523.word2:v2d65_0x0V0x1523.word2 + 160]), 6);
            v63 = v64 = MEM[64];
            ...
            if (v65) {
                ...
                if (!v57) {
                    if (11664 >= 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2) {
                        MEM[0] = MEM[0];
                ...
                if (!v57) {
                    if (0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2 <= 11664) {
                        v84, v46 = v85 = 0x2f94(v47, 0x15a2f);
                        v86 = v87 = uint24(v84);
                        v88 = v89 = 0x2ac3();
                    } else {
                        MEM[0] = MEM[0];
                        v90, v46 = 0x2f94(0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2, 0x15a02);
                        v86 = v91 = uint24(v90);
                        v88 = v92 = 0x2ac3();
                    }
                } else {
                ...
                v98 = v99 = 11807;
                v100 = new struct(3);
                v100.word1 = keccak256(MEM[v2df9_0x0V0x1523.word2:v2df9_0x0V0x1523.word2 + 160]);
                v100.word2 = 6;
                v100.word0 = 64;
                require(!((v100 + 96 > uint64.max) | (v100 + 96 < v100)), Panic(65)); // failed memory allocation (too much memory)
                v101 = v100.word0.length;
                v102 = v103 = keccak256(keccak256(MEM[v2df9_0x0V0x1523.word2:v2df9_0x0V0x1523.word2 + 160]), 6);
                v104 = v105 = MEM[64];
                ...
                if (v106) {
                    ...
                    if (v125) {
                        ...
                        if (v125) {
                            ...
                            v132 = 32;
                            if (32 > RETURNDATASIZE()) {
                                // Unknown jump to Block 0x8cb0x2c06B0x1523. Refer to 3-address code (TAC);
                            }
                        } else {
                        ...
                        v129 = v137 = MEM[v123];
                        // Unknown jump to Block ['0x43bc0x2c06B0x1523', '0x8c50x2c06B0x1523']. Refer to 3-address code (TAC);
                        v133 = this.balance;
                        ...
                        if (!v140) {
                            ...
                            if (this.balance <= v149 / 1000) {
                                MEM[0] = MEM[0];
                                v151 = 0x2b27(v129);
                                0x44ff(v151, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                            }
                            if (v149 / 1000) {
                            ...
                            // Unknown jump to Block 0x15f340x2c06B0x1523. Refer to 3-address code (TAC);
                        }
                        // Unknown jump to Block ['0x2ed8B0x1523', '0x2f4eB0x1523']. Refer to 3-address code (TAC);
                        // Unknown jump to Block 0x2ed8B0x1523. Refer to 3-address code (TAC);
                        v132 = v154 = RETURNDATASIZE();
                        // Unknown jump to Block 0x8b30x2c06B0x1523. Refer to 3-address code (TAC);
                        v1 = v155 = v129 + v133;
                        ...
                        while (1) {
                            ...
                            if (uint96.max + 1 <= v166) {
                                ...
                                if (v158 * v1 % uint256.max - v158 * v1 == v158 * v1 % uint256.max < v158 * v1) {
                                    v158 = v158 * v1 >> 96;
                                    // Unknown jump to Block ['0x37010x2c06B0x1523', '0x37060x2c06B0x1523']. Refer to 3-address code (TAC);
                                } else {
                        ...
                        if (v158 <= v1) {
                            ...
                            if (bool(MEM[v1])) {
                                ...
                                // Unknown jump to Block 0x2b8a0x2c06B0x1523. Refer to 3-address code (TAC);
                            }
                        } else {
                            v1 = v186 = 11992;
                            v169 = v187 = 1666;
                        ...
                        v179 = v197 = v183 / v185;
                        // Unknown jump to Block ['0x66f0x2c06B0x1523', '0x7ce0x2c06B0x1523']. Refer to 3-address code (TAC);
                        MEM[v1] = address(v179);
                        // Unknown jump to Block ['0x132760x2c06B0x1523', '0x135380x2c06B0x1523']. Refer to 3-address code (TAC);
                        v198 = !MEM[v1];
                        MEM[v1] = bool(v198);
                        v199 = MEM[v1];
                        v200 = v201 = bool(v199);
                        if (bool(v200)) {
                            ...
                            MEM[v1] = bool(v202);
                            v203 = bool(MEM[v1]);
                            // Unknown jump to Block 0x15912B0x1523. Refer to 3-address code (TAC);
                        } else {
                        ...
                        v211 = MEM[v1];
                        v200 = bool(v211);
                        // Unknown jump to Block 0x1585fB0x1523. Refer to 3-address code (TAC);
                        MEM[v1] = address(v179);
                        // Unknown jump to Block ['0x12f1c0x2c06B0x1523', '0x131a40x2c06B0x1523']. Refer to 3-address code (TAC);
                        v212 = MEM[v1];
                        v213 = v214 = bool(v212);
                        if (bool(v213)) {
                            MEM[v1] = address(address(MEM[v1]) >> 48);
                            v215 = bool(MEM[v1]);
                            // Unknown jump to Block 0x1576fB0x1523. Refer to 3-address code (TAC);
                        } else {
                        ...
                        v1 = v224 = 0;
                        v1 = v225 = 0x1617e;
                        0x4464(address(MEM[v1]));
                        v1 = v226 = v1 + 32;
                        0x4464(uint128(MEM[v226]));
                        0x4464(v1);
                        0x4464(address(MEM[v1]));
                        v227 = v228 = v1 + 32;
                        0x4464(uint128(MEM[v228]));
                        0x4464(v1);
                        0x4464(address(MEM[v1]));
                        v1 = v229 = v1 + 32;
                        0x4464(uint128(MEM[v229]));
                        0x4464(v1);
                        0x4464(v1);
                        v230 = v231 = 15860;
                        ...
                        while (1) {
                            ...
                            // Unknown jump to Block ['0x380f0x2c06B0x1523', '0x3df4B0x1523']. Refer to 3-address code (TAC);
                            v230 = v234 = 14351;
                            v1 = v235 = address(MEM[v1]);
                            v1 = v236 = uint128(MEM[v227]);
                            v1 = v237 = address(MEM[v1]);
                        }
                        v238 = 0x40a8(v1, v227, v1, v1, v1, v1, v233, v1, v1);
                        0x4464(v238);
                        v239 = new struct(21);
                        v239.word1 = 5;
                        v239.word2 = v238;
                        ...
                        v252 = MEM[v1];
                        v213 = bool(v252);
                        // Unknown jump to Block 0x15729B0x1523. Refer to 3-address code (TAC);
                        revert();
                    }
                    revert(MEM[64], RETURNDATASIZE());
                    ...
                    v110 = v254 = MEM[v104];
                    // Unknown jump to Block ['0x3695B0x2dfaB0x1523', '0x36b2B0x2dfaB0x1523']. Refer to 3-address code (TAC);
                    // Unknown jump to Block 0x366eB0x2dfaB0x1523. Refer to 3-address code (TAC);
                }
                revert(MEM[64], RETURNDATASIZE());
                require(!((v63 + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) > uint64.max) | (v63 + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) < v63)), Panic(65)); // failed memory allocation (too much memory)
                MEM[64] = v63 + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
                ...
                require(v73 - v63 >= 32);
                v69 = v256 = MEM[v63];
                // Unknown jump to Block ['0x3695B0x2d87B0x1523', '0x36b2B0x2d87B0x1523']. Refer to 3-address code (TAC);
                // Unknown jump to Block 0x366eB0x2d87B0x1523. Refer to 3-address code (TAC);
            }
            revert(MEM[64], RETURNDATASIZE());
            ...
            require(v36 - v26 >= 32);
            v32 = v258 = MEM[v26];
            // Unknown jump to Block ['0x3695B0x2cd0B0x1523', '0x36b2B0x2cd0B0x1523']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x366eB0x2cd0B0x1523. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
    }
}
...
function 0x30f76ad9(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8) public payable { 
    ...
    if (!v0) {
        ...
        if (v12) {
            ...
            require(v23 - v10 >= 32);
            v16 = MEM[v10];
            // Unknown jump to Block ['0x43bc0x20d', '0x8c50x20d']. Refer to 3-address code (TAC);
            v21 = this.balance;
            ...
            if (!v26) {
                ...
                if (this.balance <= v36 / 1000) {
                    MEM[0] = MEM[0];
                    v38 = 0x2b27(v16);
                    0x44ff(v38, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v36 / 1000) {
                ...
                // Unknown jump to Block 0x15e470x20d. Refer to 3-address code (TAC);
            }
            // Unknown jump to Block ['0x13a97', '0x13e05']. Refer to 3-address code (TAC);
            exit;
            exit;
            ...
            while (1) {
                ...
                if (uint96.max + 1 <= v53) {
                    ...
                    if (v45 * v1 % uint256.max - v52 == v45 * v1 % uint256.max < v52) {
                        v45 = v52 >> 96;
                        // Unknown jump to Block ['0x37010x20d', '0x37060x20d']. Refer to 3-address code (TAC);
                    } else {
            ...
            v98 = v84.call(MEM[v15e680x20d_0x1:v15e680x20d_0x1 + v1649V0x331bV0x160e0 - v15e680x20d_0x1], MEM[v15e680x20d_0x1:v15e680x20d_0x1 + v38c60x20d_0x6]).value(v82).gas(msg.gas);
            if (v98) {
                v1 = v99 = 0x15e47;
                if (v98) {
                    if (64 > RETURNDATASIZE()) {
    ...
    if (!v0) {
        ...
        if (v34) {
            ...
            if (v66) {
                ...
                if (v85) {
                    ...
                    while (1) {
                        ...
                        if (uint96.max + 1 <= v108) {
                            ...
                            if (v99 * v1 % uint256.max - v107 == v99 * v1 % uint256.max < v107) {
                                v99 = v107 >> 96;
                                // Unknown jump to Block ['0x37010x21c', '0x37060x21c']. Refer to 3-address code (TAC);
                            } else {
                    ...
                    if (v99 <= v1) {
                        ...
                        if (bool(MEM[v1 + 96])) {
                            ...
                            // Unknown jump to Block 0x2b8a0x21c. Refer to 3-address code (TAC);
                        }
                    } else {
                        v109 = v127 = 0x12e92;
                        v1 = v128 = 0x12eb5;
                    ...
                    MEM[v1] = address(v120);
                    // Unknown jump to Block ['0x132760x21c', '0x135380x21c']. Refer to 3-address code (TAC);
                    MEM[v1] = bool(!MEM[v1]);
                    v139 = bool(MEM[v1]);
                    if (bool(v139)) {
                        MEM[v1] = address(address(MEM[v1]) >> 48);
                        ...
                        // Unknown jump to Block 0x131c9. Refer to 3-address code (TAC);
                    } else {
                    ...
                    v161 = v151.call(MEM[v21c0x15de0:v21c0x15de0 + v1649V0x331bV0x15e8f0x21c - v21c0x15de0], MEM[v21c0x15de0:v21c0x15de0 + v21c0x37a6]).value(v150).gas(msg.gas);
                    if (v161) {
                        v101 = v162 = 0x15e47;
                        if (v161) {
                            if (64 > RETURNDATASIZE()) {
                    ...
                    // Unknown jump to Block 0x420e0x21c. Refer to 3-address code (TAC);
                    MEM[v1] = bool(!MEM[v1]);
                    v139 = v165 = bool(MEM[v1]);
                    // Unknown jump to Block 0x1320d. Refer to 3-address code (TAC);
                    MEM[v1] = address(v120);
                    // Unknown jump to Block ['0x12f1c0x21c', '0x131a40x21c']. Refer to 3-address code (TAC);
                    v166 = bool(MEM[v1]);
                    if (bool(v166)) {
                        MEM[v1] = address(address(MEM[v1]) >> 48);
                        v167 = v168 = bool(MEM[v1]);
                        // Unknown jump to Block 0x12e92. Refer to 3-address code (TAC);
                    } else {
                    ...
                    // Unknown jump to Block 0x12ed6. Refer to 3-address code (TAC);
                    revert();
                    ...
                    require(v190 - v83 >= 32);
                    v89 = MEM[v83];
                    // Unknown jump to Block ['0x43bc0x21c', '0x8c50x21c']. Refer to 3-address code (TAC);
                    ...
                    if (!v98) {
                        ...
                        // Unknown jump to Block ['0x15e470x21c', '0x15f340x21c']. Refer to 3-address code (TAC);
                    } else {
                        ...
                        if (this.balance <= v203 / 1000) {
                            MEM[0] = MEM[0];
                            v205 = 0x2b27(v89);
                            0x44ff(v205, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                        }
                        if (v203 / 1000) {
                ...
                require(v74 - v64 >= 32);
                v70 = v210 = MEM[v64];
                // Unknown jump to Block ['0x3695B0x56d', '0x36b2B0x56d']. Refer to 3-address code (TAC);
                // Unknown jump to Block 0x366eB0x56d. Refer to 3-address code (TAC);
            }
            revert(MEM[64], RETURNDATASIZE());
            ...
            require(v42 - v32 >= 32);
            v38 = v212 = MEM[v32];
            // Unknown jump to Block ['0x3695B0x4fb', '0x36b2B0x4fb']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x366eB0x4fb. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
...
function 0x2b5f(uint256 varg0) private { 
    require(varg0 <= varg0 + 1000, Panic(17)); // arithmetic overflow or underflow
    return varg0 + 1000;
}

function 0x2b6e(uint256 varg0) private { 
...
function 0x2f94(uint256 varg0, uint256 varg1) private { 
    require(10 ** 6 - v0 <= 10 ** 6, Panic(17)); // arithmetic overflow or underflow
    return 10 ** 6 - v0, varg0;
}

function 0x3075(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    require(32 <= varg2);
    require(varg2 <= varg1);
...
function 0x3384(uint256 varg0) private { 
    v0 = varg0 >> 224;
    v1 = bool(varg0 >> 148);
    if (v1 - 1) {
        if (v1 - 4) {
...
function 0x354e(struct(4) varg0) private { 
    v0 = varg0.word2.slot0().gas(msg.gas);
    require(v0);
    return ;
}

function 0x356c(uint256 varg0) private { 
    v0, /* uint128 */ v1 = varg0.liquidity().gas(msg.gas);
    require((RETURNDATASIZE() > 15) & v0);
    return uint128(v1);
}

function 0x3845(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    require(v0 != int256.min, Panic(17)); // arithmetic overflow or underflow
    return 0 - v0, varg2, varg0;
}

function 0x3eaa(address varg0, uint256 varg1) private { 
    v0 = new bytes[](68);
...
function 0x3f51(uint256 varg0) private { 
    v0 = new bytes[](68);
    MEM[v0.data] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000;
...
function 0x40a8(address varg0, uint128 varg1, address varg2, uint128 varg3, uint256 varg4, address varg5, uint256 varg6, uint256 varg7, uint256 varg8) private { 
...
function 0x4464(uint256 varg0) private { 
    v0 = new bytes[](36);
...
function 0x44b9(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = v1 = varg2 > varg0;
    if (varg2 <= varg0) {
        v0 = v2 = varg2 == varg0;
        if (v2) {
...
function 0x44ff(uint256 varg0, uint256 varg1) private { 
