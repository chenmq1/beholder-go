...
function 0xbdb69421(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    if (!v2) {
        0x431b(varg0 >> 96, varg1 >> 96, msg.data[msg.data.length - 32]);
        return v0;
    } else {
        return v0;
    }
        ...
        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v9)) {
            ...
            if ((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v10) {
                ...
                if ((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v11) {
                    // Unknown jump to Block 0x1410. Refer to 3-address code (TAC);
                }
            }
...
function 0xa87a1ae8(uint256 varg0, uint256 varg1, uint256 varg2) public nonPayable { 
    ...
    if (v16) {
        ...
        v28 = v46 = 6230;
        v30 = v47 = 0x16c19;
        v35 = v48 = 0x42e6(varg2, v0);
    }
    require(10 ** 18, Panic(18)); // division by zero
    v49 = v35 * v32 / 10 ** 18;
    // Unknown jump to Block ['0x16c19', '0x16c45']. Refer to 3-address code (TAC);
    v50 = v51 = varg1 >> 96;
    v52 = 0x481b(v50, varg0 >> 96, varg2);
    if (!v52) {
        v53 = 0x487f(v50, varg0 >> 96);
        v54 = !v53;
        if (bool(v53)) {
            v55 = 0x481b(v50, varg0 >> 96, varg2);
            v54 = v56 = !v55;
        }
        require(!v54, ForceApproveFailed());
        // Unknown jump to Block 0x1856. Refer to 3-address code (TAC);
    }
    ...
    return v49;
    v50 = v61 = varg1 >> 96;
    // Unknown jump to Block 0x3d180x1696. Refer to 3-address code (TAC);
}
...
function 0xfd53121f(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    v11 = 0x481b(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v0);
    if (!v11) {
        v12 = 0x487f(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48, 0xf6e72db5454dd049d0788e411b06cfaf16853042);
        v13 = v14 = !v12;
        if (bool(v12)) {
            v15 = 0x481b(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v0);
            v13 = v16 = !v15;
        }
...
function 0x9df46e8c(uint256 varg0, uint256 varg1, address varg2) public nonPayable { 
    ...
    0x3d5e(varg1, 0xba1333333333a1ba1108e8412f11850a5c319ba9, MEM[MEM[64] + 32]);
            ...
            if (v18 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v30 = (MEM[v16] >> 96).call(MEM[v4513V0x1cbe:v4513V0x1cbe + 68], MEM[0:32]).gas(msg.gas);
                        ...
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v31 = (MEM[v16] >> 96).call(MEM[v4513V0x1cbe:v4513V0x1cbe + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v31)) {
                            MEM[v15 + 36] = 0;
                            v32 = (MEM[v16] >> 96).call(MEM[v4513V0x1cbe:v4513V0x1cbe + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v32, ApproveFailed());
                            MEM[v15 + 36] = v18;
                            v33 = (MEM[v16] >> 96).call(MEM[v4513V0x1cbe:v4513V0x1cbe + 68], MEM[0:32]).gas(msg.gas);
                ...
                if (v16 > v14) {
                    ...
                    if (v23 > v41) {
                        ...
                        v42 = v19.call(MEM[v4649_0x2V0x1cbe:v4649_0x2V0x1cbe + v45b8_0x0V0x1cbe - v4649_0x2V0x1cbe], MEM[v4649_0x2V0x1cbe:v4649_0x2V0x1cbe + uint8.max + 1]).value(v23).gas(msg.gas);
                        if (!v42) {
            ...
            if (v51 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v63 = (MEM[v49] >> 96).call(MEM[v4513V0x1ca8:v4513V0x1ca8 + 68], MEM[0:32]).gas(msg.gas);
                        ...
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v64 = (MEM[v49] >> 96).call(MEM[v4513V0x1ca8:v4513V0x1ca8 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v64)) {
                            MEM[v48 + 36] = 0;
                            v65 = (MEM[v49] >> 96).call(MEM[v4513V0x1ca8:v4513V0x1ca8 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v65, ApproveFailed());
                            MEM[v48 + 36] = v51;
                            v66 = (MEM[v49] >> 96).call(MEM[v4513V0x1ca8:v4513V0x1ca8 + 68], MEM[0:32]).gas(msg.gas);
                ...
                if (v49 > v47) {
                    ...
                    if (v56 > v74) {
                        ...
                        v75 = v52.call(MEM[v4649_0x2V0x1ca8:v4649_0x2V0x1ca8 + v45b8_0x0V0x1ca8 - v4649_0x2V0x1ca8], MEM[v4649_0x2V0x1ca8:v4649_0x2V0x1ca8 + uint8.max + 1]).value(v56).gas(msg.gas);
                        if (!v75) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
            ...
            if (v78 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v97 = (MEM[v84] >> 96).call(MEM[v4513V0x16c71:v4513V0x16c71 + 68], MEM[0:32]).gas(msg.gas);
                        ...
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v98 = (MEM[v84] >> 96).call(MEM[v4513V0x16c71:v4513V0x16c71 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v98)) {
                            MEM[v83 + 36] = 0;
                            v99 = (MEM[v84] >> 96).call(MEM[v4513V0x16c71:v4513V0x16c71 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v99, ApproveFailed());
                            MEM[v83 + 36] = v78;
                            v100 = (MEM[v84] >> 96).call(MEM[v4513V0x16c71:v4513V0x16c71 + 68], MEM[0:32]).gas(msg.gas);
                ...
                if (v84 > v82) {
                    ...
                    if (v90 > v108) {
                        ...
                        v109 = v86.call(MEM[v4649_0x2V0x16c71:v4649_0x2V0x16c71 + v45b8_0x0V0x16c71 - v4649_0x2V0x16c71], MEM[v4649_0x2V0x16c71:v4649_0x2V0x16c71 + uint8.max + 1]).value(v90).gas(msg.gas);
                        if (!v109) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
    ...
    if (v1 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
        ...
        if (MEM[MEM[64]] >> 240 & 0x1800) {
            ...
            if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                ...
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v20 = (MEM[v7] >> 96).call(MEM[v21b3:v21b3 + 68], MEM[0:32]).gas(msg.gas);
                ...
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v21 = (MEM[v7] >> 96).call(MEM[v21b3:v21b3 + 68], MEM[0:32]).gas(msg.gas);
                if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v21)) {
                    MEM[v6 + 36] = 0;
                    v22 = (MEM[v7] >> 96).call(MEM[v21b3:v21b3 + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v22, ApproveFailed());
                    MEM[v6 + 36] = v1;
                    v23 = (MEM[v7] >> 96).call(MEM[v21b3:v21b3 + 68], MEM[0:32]).gas(msg.gas);
        ...
        if (v5 < v7) {
            ...
            v31 = v9.call(MEM[va1c9_0x8:va1c9_0x8 + v22ba_0x0 - va1c9_0x8], MEM[va1c9_0x8:va1c9_0x8 + uint8.max + 1]).value(v13).gas(msg.gas);
            if (!v31) {
                if (0x20 & MEM[MEM[64]] >> 240) {
        ...
        if (v39 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v44 + 4] = v47;
                    MEM[v44 + 36] = v39;
                    v58 = (MEM[v45] >> 96).call(MEM[v4513V0x21f1:v4513V0x21f1 + 68], MEM[0:32]).gas(msg.gas);
                    ...
                    MEM[v44 + 4] = v47;
                    MEM[v44 + 36] = v39;
                    v59 = (MEM[v45] >> 96).call(MEM[v4513V0x21f1:v4513V0x21f1 + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v59)) {
                        MEM[v44 + 36] = 0;
                        v60 = (MEM[v45] >> 96).call(MEM[v4513V0x21f1:v4513V0x21f1 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v60, ApproveFailed());
                        MEM[v44 + 36] = v39;
                        v61 = (MEM[v45] >> 96).call(MEM[v4513V0x21f1:v4513V0x21f1 + 68], MEM[0:32]).gas(msg.gas);
            ...
            if (v45 > v43) {
                ...
                v69 = v47.call(MEM[v4649_0x2V0x21f1:v4649_0x2V0x21f1 + v45b8_0x0V0x21f1 - v4649_0x2V0x21f1], MEM[v4649_0x2V0x21f1:v4649_0x2V0x21f1 + uint8.max + 1]).value(v51).gas(msg.gas);
                if (!v69) {
                    if (0x20 & MEM[MEM[64]] >> 240) {
...
function 0x773e7756(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5) public nonPayable { 
    ...
    if (varg0 >> 96) {
        0x3d5e(varg0 >> 96, varg1 >> 96, v0 / 0x186a0);
        0x3d5e(varg0 >> 96, varg3 >> 96, v1 / 0x186a0);
        return v3;
    } else {
...
function chargeFee(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    if (varg0 >> 96) {
        0x3d5e(varg0 >> 96, varg1 >> 96, varg2);
        return v0;
    } else {
...
function 0x7225b0d0(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5) public nonPayable { 
    ...
    if (varg0 >> 96) {
        0x3d5e(varg0 >> 96, varg1 >> 96, varg2);
        0x3d5e(varg0 >> 96, varg3 >> 96, varg4);
        return v1;
    } else {
...
function swapUniV2(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    MEM[v19 + 100] = 128;
    MEM[v19 + 132] = 0;
    v23 = (varg2 >> 96).call(MEM[va63d_0x1:va63d_0x1 + 164 - 0x40 & 0x0 byte varg0], MEM[0:0]).gas(msg.gas);
    if (!v23) {
...
function swapSolidly(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    if (1 == (byte(varg0, 0x0)) >> 4 & 0x1) {
        ...
        while (v38 < uint8.max) {
            ...
            break;
            v41 = v43 = 1;
            // Unknown jump to Block 0x2e31. Refer to 3-address code (TAC);
        }
        if (1 == (byte(varg0, 0x0)) >> 7) {
        ...
        if (v8 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v17 + 4] = v20;
                    MEM[v17 + 36] = v8;
                    v31 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16dcd:v4513V0x3b9fV0x16dcd + 68], MEM[0:32]).gas(msg.gas);
                    ...
                    MEM[v17 + 4] = v20;
                    MEM[v17 + 36] = v8;
                    v32 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16dcd:v4513V0x3b9fV0x16dcd + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v32)) {
                        MEM[v17 + 36] = 0;
                        v33 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16dcd:v4513V0x3b9fV0x16dcd + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v33, ApproveFailed());
                        MEM[v17 + 36] = v8;
                        v34 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16dcd:v4513V0x3b9fV0x16dcd + 68], MEM[0:32]).gas(msg.gas);
            ...
            if (v18 > v16) {
                ...
                if (v24 > v42) {
                    ...
                    v43 = v20.call(MEM[v4649_0x2V0x3b9fV0x16dcd:v4649_0x2V0x3b9fV0x16dcd + v45b8_0x0V0x3b9fV0x16dcd - v4649_0x2V0x3b9fV0x16dcd], MEM[v4649_0x2V0x3b9fV0x16dcd:v4649_0x2V0x3b9fV0x16dcd + uint8.max + 1]).value(v24).gas(msg.gas);
                    if (!v43) {
                        if (0x20 & MEM[MEM[64]] >> 240) {
...
function 0x3dd5cfd1(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    v11 = 0x481b(0x6b175474e89094c44da98b954eedeac495271d0f, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v8);
    if (!v11) {
        v12 = 0x487f(0x6b175474e89094c44da98b954eedeac495271d0f, 0xf6e72db5454dd049d0788e411b06cfaf16853042);
        v13 = v14 = !v12;
        if (bool(v12)) {
            v15 = 0x481b(0x6b175474e89094c44da98b954eedeac495271d0f, 0xf6e72db5454dd049d0788e411b06cfaf16853042, v8);
            v13 = v16 = !v15;
        }
        require(!v13, ForceApproveFailed());
    }
            ...
            if (v8 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v17 + 4] = v20;
                        MEM[v17 + 36] = v8;
                        v31 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16e57:v4513V0x3b9fV0x16e57 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v31, TransferFailed());
                    } else {
                        MEM[v17] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v17 + 4] = v20;
                        MEM[v17 + 36] = v8;
                        v32 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16e57:v4513V0x3b9fV0x16e57 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v32)) {
                            MEM[v17 + 36] = 0;
                            v33 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16e57:v4513V0x3b9fV0x16e57 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v33, ApproveFailed());
                            MEM[v17 + 36] = v8;
                            v34 = (MEM[v18] >> 96).call(MEM[v4513V0x3b9fV0x16e57:v4513V0x3b9fV0x16e57 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v34, ApproveFailed());
                        }
                    }
                }
                ...
                if (v18 > v16) {
                    ...
                    if (v24 > v42) {
                        ...
                        v43 = v20.call(MEM[v4649_0x2V0x3b9fV0x16e57:v4649_0x2V0x3b9fV0x16e57 + v45b8_0x0V0x3b9fV0x16e57 - v4649_0x2V0x3b9fV0x16e57], MEM[v4649_0x2V0x3b9fV0x16e57:v4649_0x2V0x3b9fV0x16e57 + uint8.max + 1]).value(v24).gas(msg.gas);
                        if (!v43) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v18, 0, RETURNDATASIZE());
                                revert(v18, RETURNDATASIZE());
...
function tokenApprove(uint256 varg0, uint256 varg1, uint256 varg2) public nonPayable { 
    require(msg.data.length - 4 >= 0);
    require(!(msg.sender - this), OnlyThis());
    0x3d18(varg0 >> 96, varg1 >> 96, varg2);
    return varg2;
}
        ...
        if (v0 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v0;
                    v25 = (MEM[v12] >> 96).call(MEM[v4513V0x37a3:v4513V0x37a3 + 68], MEM[0:32]).gas(msg.gas);
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v0;
                    v26 = (MEM[v12] >> 96).call(MEM[v4513V0x37a3:v4513V0x37a3 + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                        MEM[v11 + 36] = 0;
                        v27 = (MEM[v12] >> 96).call(MEM[v4513V0x37a3:v4513V0x37a3 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                        MEM[v11 + 36] = v0;
                        v28 = (MEM[v12] >> 96).call(MEM[v4513V0x37a3:v4513V0x37a3 + 68], MEM[0:32]).gas(msg.gas);
            ...
            if (v12 > v10) {
                ...
                if (v18 > v36) {
                    ...
                    v37 = v14.call(MEM[v4649_0x2V0x37a3:v4649_0x2V0x37a3 + v45b8_0x0V0x37a3 - v4649_0x2V0x37a3], MEM[v4649_0x2V0x37a3:v4649_0x2V0x37a3 + uint8.max + 1]).value(v18).gas(msg.gas);
                    if (!v37) {
                        if (0x20 & MEM[MEM[64]] >> 240) {
        ...
        if (v0 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
            ...
            if (MEM[MEM[64]] >> 240 & 0x1800) {
                ...
                if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                    ...
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v0;
                    v25 = (MEM[v12] >> 96).call(MEM[v4513V0x382f:v4513V0x382f + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v25, TransferFailed());
                } else {
                    MEM[v11] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                    MEM[v11 + 4] = v14;
                    MEM[v11 + 36] = v0;
                    v26 = (MEM[v12] >> 96).call(MEM[v4513V0x382f:v4513V0x382f + 68], MEM[0:32]).gas(msg.gas);
                    if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v26)) {
                        MEM[v11 + 36] = 0;
                        v27 = (MEM[v12] >> 96).call(MEM[v4513V0x382f:v4513V0x382f + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v27, ApproveFailed());
                        MEM[v11 + 36] = v0;
                        v28 = (MEM[v12] >> 96).call(MEM[v4513V0x382f:v4513V0x382f + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v28, ApproveFailed());
                    }
                }
            }
            ...
            if (v12 > v10) {
                ...
                if (v18 > v36) {
                    ...
                    v37 = v14.call(MEM[v4649_0x2V0x382f:v4649_0x2V0x382f + v45b8_0x0V0x382f - v4649_0x2V0x382f], MEM[v4649_0x2V0x382f:v4649_0x2V0x382f + uint8.max + 1]).value(v18).gas(msg.gas);
                    if (!v37) {
                        if (0x20 & MEM[MEM[64]] >> 240) {
                            RETURNDATACOPY(v12, 0, RETURNDATASIZE());
                            revert(v12, RETURNDATASIZE());
...
function 0x3c7d(uint256 varg0) private { 
...
function 0x3d18(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = 0x481b(varg0, varg1, varg2);
    if (!v0) {
        v1 = 0x487f(varg0, varg1);
        v2 = !v1;
        if (bool(v1)) {
            v3 = 0x481b(varg0, varg1, varg2);
            v2 = v4 = !v3;
        }
...
function 0x3d5e(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    ...
    if (v1 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
        ...
        if (MEM[MEM[64]] >> 240 & 0x1800) {
            ...
            if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                ...
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v20 = (MEM[v7] >> 96).call(MEM[v3f0c:v3f0c + 68], MEM[0:32]).gas(msg.gas);
                require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v20, TransferFailed());
            } else {
                MEM[v6] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                MEM[v6 + 4] = v9;
                MEM[v6 + 36] = v1;
                v21 = (MEM[v7] >> 96).call(MEM[v3f0c:v3f0c + 68], MEM[0:32]).gas(msg.gas);
                if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v21)) {
                    MEM[v6 + 36] = 0;
                    v22 = (MEM[v7] >> 96).call(MEM[v3f0c:v3f0c + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v22, ApproveFailed());
                    MEM[v6 + 36] = v1;
                    v23 = (MEM[v7] >> 96).call(MEM[v3f0c:v3f0c + 68], MEM[0:32]).gas(msg.gas);
                    require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v23, ApproveFailed());
                }
            }
        }
        ...
        if (v7 > v5) {
            ...
            v31 = v9.call(MEM[vb14f_0x2:vb14f_0x2 + v3fb3_0x0 - vb14f_0x2], MEM[vb14f_0x2:vb14f_0x2 + uint8.max + 1]).value(v13).gas(msg.gas);
            if (!v31) {
                if (0x20 & MEM[MEM[64]] >> 240) {
                    RETURNDATACOPY(v7, 0, RETURNDATASIZE());
                    revert(v7, RETURNDATASIZE());
...
function 0x42e6(uint256 varg0, struct(11) varg1) private { 
    v0 = 0x3c7d(varg1.word0);
    v1 = 0x49a2(varg1.word4, varg1.word4, v0 * varg0 / 10 ** 18, varg1.word1);
    return varg1.word4 - v1;
}

function 0x431b(uint256 varg0, address varg1, uint256 varg2) private { 
    if (varg2) {
        v0 = v1 = !address(varg0);
...
function 0xfbb7cd06(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    if (bool(varg2 >> 96)) {
        0x3d18(varg2 >> 96, v2, msg.data[v5]);
    }
...
function 0x481b(uint256 varg0, uint256 varg1, uint256 varg2) private { 
...
function 0x487f(uint256 varg0, uint256 varg1) private { 
...
function 0x48c6(struct(11) varg0) private { 
    ...
    if (varg0.word6) {
        ...
        if (2 - varg0.word6) {
            ...
            if (1 == varg0.word6) {
                ...
                v1 = 0x4a57(varg0.word2, varg0.word1, v0);
                return varg0.word10, v1 - varg0.word2 + varg0.word2;
            } else {
                return 0, 0;
            }
        } else {
            v2 = 0x4a57(varg0.word3, varg0.word1, varg0.word0 * (varg0.word2 - varg0.word9) / 10 ** 18);
...
function 0x49a2(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = varg3 * varg0 / 10 ** 18 * varg0;
    v1 = _SafeDiv(v0, varg1);
    v2 = (10 ** 18 - varg3) * varg1 / 10 ** 18;
    if (v2 < v1 + varg2) {
        v3 = v4, v5 = v6, v7 = v8, v9 = v10, v11 = v12 = 0x49e2(v0, 10 ** 18, 18929, v1 + varg2 - v2, 0, 10 ** 18);
    } else {
        v3 = v13, v5 = v14, v7 = v15, v9 = v16, v11 = v17 = 0x49e2(v0, 10 ** 18, 18929, v2 - (v1 + varg2), 1, 10 ** 18);
    }
    if (!v7) {
        v18 = v19 = v3 - v5;
    } else {
...
function 0x49e2(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5) private { 
...
function 0x4a1e(uint256 varg0) private { 
    if (1 == varg0 > 2) {
        varg0 = v0 = (varg0 >> 1) + 1;
        while (varg0 < varg0) {
...
function 0x4a57(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = 0x4ab9((varg1 * varg2 / 10 ** 18 << 2) * 10 ** 18, varg0);
    v1 = 0x4a1e((v0 + 10 ** 18) * 10 ** 18);
    v2 = 0x4ab9((v1 + 0xfffffffffffffffffffffffffffffffffffffffffffffffff21f494c589c0000) * 10 ** 18, varg1 << 1);
    return (10 ** 18 + v2) * varg0 / 10 ** 18;
}

function 0x4ab9(uint256 varg0, uint256 varg1) private { 
...
function 0xf2fa6b66(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) public nonPayable { 
    ...
    if (varg3 > varg1) {
        if (varg3 - varg1 > varg2 >> 128) {
            if (varg3 - varg1 > varg2 >> 128) {
                0x431b(varg0 >> 96, 0xb01f8f528702d411d24c9bb8cc0e2fff779ec013, varg3 - varg1);
...
function 0xe2e1d3c6(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4) public nonPayable { 
    ...
    0x3d18(varg1 >> 96, address(MEM[0x0]), varg4);
    v1 = new uint256[](3);
    ...
    if (varg5 > varg1) {
        if (varg5 - varg1 > varg2 >> 128) {
            ...
            if (varg5 - varg1 - v0 > varg2 >> 128) {
                0x431b(varg0 >> 96, 0xb01f8f528702d411d24c9bb8cc0e2fff779ec013, varg5 - varg1 - v0);
                v3 = v4 = varg5 - (varg5 - varg1 - v0);
            }
            if (v0 > varg2 >> 128) {
                0x431b(varg0 >> 96, varg4 >> 96, v0);
                v3 = v5 = v3 - v0;
            }
        }
    }
            ...
            if (v18 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v30 = (MEM[v16] >> 96).call(MEM[v4513V0x1099:v4513V0x1099 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v30, TransferFailed());
                    } else {
                        MEM[v15] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v15 + 4] = v19;
                        MEM[v15 + 36] = v18;
                        v31 = (MEM[v16] >> 96).call(MEM[v4513V0x1099:v4513V0x1099 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v31)) {
                            MEM[v15 + 36] = 0;
                            v32 = (MEM[v16] >> 96).call(MEM[v4513V0x1099:v4513V0x1099 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v32, ApproveFailed());
                            MEM[v15 + 36] = v18;
                            v33 = (MEM[v16] >> 96).call(MEM[v4513V0x1099:v4513V0x1099 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v33, ApproveFailed());
                        }
                    }
                }
                ...
                if (v16 > v14) {
                    ...
                    if (v23 > v41) {
                        ...
                        v42 = v19.call(MEM[v4649_0x2V0x1099:v4649_0x2V0x1099 + v45b8_0x0V0x1099 - v4649_0x2V0x1099], MEM[v4649_0x2V0x1099:v4649_0x2V0x1099 + uint8.max + 1]).value(v23).gas(msg.gas);
                        if (!v42) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v16, 0, RETURNDATASIZE());
                                revert(v16, RETURNDATASIZE());
            ...
            if (v51 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v63 = (MEM[v49] >> 96).call(MEM[v4513V0x1083:v4513V0x1083 + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v63, TransferFailed());
                    } else {
                        MEM[v48] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v48 + 4] = v52;
                        MEM[v48 + 36] = v51;
                        v64 = (MEM[v49] >> 96).call(MEM[v4513V0x1083:v4513V0x1083 + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v64)) {
                            MEM[v48 + 36] = 0;
                            v65 = (MEM[v49] >> 96).call(MEM[v4513V0x1083:v4513V0x1083 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v65, ApproveFailed());
                            MEM[v48 + 36] = v51;
                            v66 = (MEM[v49] >> 96).call(MEM[v4513V0x1083:v4513V0x1083 + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v66, ApproveFailed());
                        }
                    }
                }
                ...
                if (v49 > v47) {
                    ...
                    if (v56 > v74) {
                        ...
                        v75 = v52.call(MEM[v4649_0x2V0x1083:v4649_0x2V0x1083 + v45b8_0x0V0x1083 - v4649_0x2V0x1083], MEM[v4649_0x2V0x1083:v4649_0x2V0x1083 + uint8.max + 1]).value(v56).gas(msg.gas);
                        if (!v75) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v49, 0, RETURNDATASIZE());
                                revert(v49, RETURNDATASIZE());
            ...
            if (v78 | !(MEM[MEM[64]] >> 240 & 0x8000)) {
                ...
                if (MEM[MEM[64]] >> 240 & 0x1800) {
                    ...
                    if (!(MEM[MEM[64]] >> 240 & 0x1000)) {
                        ...
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v97 = (MEM[v84] >> 96).call(MEM[v4513V0x16b2c:v4513V0x16b2c + 68], MEM[0:32]).gas(msg.gas);
                        require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v97, TransferFailed());
                    } else {
                        MEM[v83] = 0x95ea7b300000000000000000000000000000000000000000000000000000000;
                        MEM[v83 + 4] = v86;
                        MEM[v83 + 36] = v78;
                        v98 = (MEM[v84] >> 96).call(MEM[v4513V0x16b2c:v4513V0x16b2c + 68], MEM[0:32]).gas(msg.gas);
                        if (!((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v98)) {
                            MEM[v83 + 36] = 0;
                            v99 = (MEM[v84] >> 96).call(MEM[v4513V0x16b2c:v4513V0x16b2c + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v99, ApproveFailed());
                            MEM[v83 + 36] = v78;
                            v100 = (MEM[v84] >> 96).call(MEM[v4513V0x16b2c:v4513V0x16b2c + 68], MEM[0:32]).gas(msg.gas);
                            require((!RETURNDATASIZE() | (RETURNDATASIZE() > 31) & (MEM[0] == 1)) & v100, ApproveFailed());
                        }
                    }
                }
                ...
                if (v84 > v82) {
                    ...
                    if (v90 > v108) {
                        ...
                        v109 = v86.call(MEM[v4649_0x2V0x16b2c:v4649_0x2V0x16b2c + v45b8_0x0V0x16b2c - v4649_0x2V0x16b2c], MEM[v4649_0x2V0x16b2c:v4649_0x2V0x16b2c + uint8.max + 1]).value(v90).gas(msg.gas);
                        if (!v109) {
                            if (0x20 & MEM[MEM[64]] >> 240) {
                                RETURNDATACOPY(v84, 0, RETURNDATASIZE());
                                revert(v84, RETURNDATASIZE());
