...
function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes data) public nonPayable { 
    ...
    if (msg.data[4 + data]) {
        ...
        if (uint8(data.word1) - 11) {
            ...
            if (uint8(data.word1) - 13) {
                if (uint8(data.word1) - 14) {
                    ...
                    if (uint8(data.word1) - 22) {
                        ...
                        v3 = v4 = 0;
                        v5 = v6 = 0x16a1d;
                        v7, v8 = 0x36aa(4 + data + 32, msg.data[4 + data], msg.data[4 + data]);
                ...
                v1 = v33 = 2156;
                v5 = v34 = 0x16927;
                v35, v36 = 0x36aa(4 + data + 32, msg.data[4 + data], msg.data[4 + data]);
            ...
            // Unknown jump to Block ['0x16927', '0x16a1d']. Refer to 3-address code (TAC);
            v40 = v41 = MEM[64];
            ...
            v44 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v16981_0x1:v16981_0x1 + 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + MEM[v35000x1d1_0x0] + v1e970x1d1_0x0 + 32 + 32 - v16981_0x1], MEM[v16981_0x1:v16981_0x1 + v86c_0x3]).value(v3).gas(msg.gas);
            if (v44) {
                if (v44) {
                    ...
                    v45 = 0x3dce(v40, v40 + RETURNDATASIZE());
                    exit;
                } else {
                    exit;
                }
            ...
            v42 = v47 = v46 + 4;
            // Unknown jump to Block 0x1e970x1d1. Refer to 3-address code (TAC);
        } else {
            v48, v49 = 0x36aa(4 + data + 32, msg.data[4 + data], msg.data[4 + data]);
        ...
        v30 = v25 + v57;
        require(v30 - v25 >= 32);
        // Unknown jump to Block ['0x169a8', '0x7af']. Refer to 3-address code (TAC);
        exit;
        revert(MEM[64], RETURNDATASIZE());
        v57 = RETURNDATASIZE();
        // Unknown jump to Block 0x79d0x1d1. Refer to 3-address code (TAC);
    } else if (0 == amount0Delta > 0) {
        0x4792(msg.sender, amount1Delta);
        exit;
    } else {
        0x4792(msg.sender, amount0Delta);
        exit;
    }
}
...
function 0xcafecc44(uint256 varg0, int24 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, bool varg10) public payable { 
    ...
    if (!v0) {
        ...
        v26 = v27 = 12728;
        v28 = new struct(3);
        v28.word1 = keccak256(MEM[v318d_0x0.word2:v318d_0x0.word2 + 160]);
        v28.word2 = 6;
        v28.word0 = 64;
        require(!((v28 + 96 > uint64.max) | (v28 + 96 < v28)), Panic(65)); // failed memory allocation (too much memory)
        v29 = v28.word0.length;
        v30 = v31 = keccak256(keccak256(MEM[v318d_0x0.word2:v318d_0x0.word2 + 160]), 6);
        v32 = v33 = MEM[64];
        ...
        if (v34) {
            ...
            if (v61) {
                ...
                require(v69 - v59 >= 32);
                v65 = MEM[v59];
                // Unknown jump to Block ['0x10b30x1e0', '0x4cdd0x1e0']. Refer to 3-address code (TAC);
                v71 = this.balance;
                ...
                if (!v26) {
                    ...
                    // Unknown jump to Block ['0x191c50x1e0', '0x192ba0x1e0']. Refer to 3-address code (TAC);
                } else {
                    ...
                    if (this.balance <= v83 / 1000) {
                        MEM[0] = MEM[0];
                        v85 = 0x35aa(v65);
                        0x5151(v85, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                    }
                    if (v83 / 1000) {
                ...
                v51 = v89 = 0x19302;
                v51 = v90 = 0x19325;
                v91 = v92 = 0x4d16(address(MEM[v51]) * address(MEM[v51]), address(MEM[v51]) * address(MEM[v51]) % uint256.max - address(MEM[v51]) * address(MEM[v51]) - (address(MEM[v51]) * address(MEM[v51]) % uint256.max < address(MEM[v51]) * address(MEM[v51])));
                if (!v26) {
                    v91 = v93 = _SafeDiv(uint192.max + 1, v92);
                }
                if (!v24) {
                    v51 = v94 = 0x4a40(MEM[v51], MEM[v51 + 32]);
                    v95 = address(MEM[v51]);
                } else {
                    v51 = v96 = 0x4a40(MEM[v51 + 32], MEM[v51]);
                ...
                while (1) {
                    ...
                    if (uint96.max + 1 <= v103) {
                        ...
                        if (v91 * v51 % uint256.max - v102 == v91 * v51 % uint256.max < v102) {
                            v91 = v102 >> 96;
                            // Unknown jump to Block ['0x193020x1e0', '0x193250x1e0']. Refer to 3-address code (TAC);
                        } else {
                ...
                if (v91 <= v51) {
                    ...
                    if (v118) {
                        ...
                        if (v118) {
                            ...
                            v120 = 0x3dce(MEM[64], MEM[64] + RETURNDATASIZE());
                        }
                    }
                } else {
                    v51 = v121 = 0x1887e;
                    ...
                    // Unknown jump to Block ['0x188c2', '0x189fc']. Refer to 3-address code (TAC);
                    ...
                    // Unknown jump to Block 0x1885b. Refer to 3-address code (TAC);
                }
                v26 = 0x3ff & v51 >> 50;
                ...
                // Unknown jump to Block 0x4b2f0x1e0. Refer to 3-address code (TAC);
                revert();
            }
            ...
            require(v42 - v32 >= 32);
            v38 = v160 = MEM[v32];
            // Unknown jump to Block ['0x3dabB0x31af', '0x3dc8B0x31af']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x3d84B0x31af. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
        ...
        // Unknown jump to Block ['0x348b', '0x34df']. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x3123. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x3125. Refer to 3-address code (TAC);
    } else {
        exit;
    }
}
...
function unlockCallback(bytes rawData) public nonPayable { 
    ...
    if (uint8(rawData.word1) - 2) {
        ...
        if (uint8(rawData.word1) - 9) {
            if (uint8(rawData.word1) - 10) {
                ...
                if (uint8(rawData.word1) - 17) {
                    ...
                    v1 = v2 = 11302;
                    v3 = v4 = 32;
                    v5, v6 = 0x36aa(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
                ...
                v1 = v19 = 10260;
                v3 = v20 = 32;
                v21, v22 = 0x36aa(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
            ...
            v3 = v37 = 32;
            v1 = v38 = 9233;
            v39, v40 = 0x36aa(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
        ...
        v3 = v55 = 32;
        v1 = v56 = 8081;
        v57, v58 = 0x36aa(4 + rawData + 32, msg.data[4 + rawData], msg.data[4 + rawData]);
    ...
    MEM[v17 + 288] = 0;
    // Unknown jump to Block ['0x1f91', '0x2411', '0x2814', '0x2c26']. Refer to 3-address code (TAC);
    v74 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v37a9_0x1 + 320 - v36e6V0x386a0x3824V0x2bf0], MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v2c26_0x3]).gas(msg.gas);
    if (v74) {
        v75 = v76 = 0;
        if (v74) {
            v77 = v78 = 9011;
    ...
    // Unknown jump to Block ['0x17f9f', '0x18018']. Refer to 3-address code (TAC);
    v120 = v121 = 192;
    v118.word0 = 160;
    require(!((v118 + 192 > uint64.max) | (v118 + 192 < v118)), Panic(65)); // failed memory allocation (too much memory)
    // Unknown jump to Block ['0x17ef4', '0x180b4']. Refer to 3-address code (TAC);
    v122 = v123 = MEM[v87];
    ...
    v126 = address(v7).call(MEM[v17ff10x1f9_0x1:v17ff10x1f9_0x1 + 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + v20ff.word0.length + v3a310x1f9_0x0 + 160 + 32 - v17ff10x1f9_0x1], MEM[v17ff10x1f9_0x1:v17ff10x1f9_0x1 + v180b4_0x7]).value(v89).gas(msg.gas);
    if (v126) {
        if (v126) {
            v127 = v128 = 8608;
            v129 = v130 = 64;
            if (64 > RETURNDATASIZE()) {
                // Unknown jump to Block 0x21a60x1f9. Refer to 3-address code (TAC);
            }
        }
    }
    v122 = v131 = MEM[v87];
    ...
    v124 = v132 = v131 + 4;
    // Unknown jump to Block 0x3a310x1f9. Refer to 3-address code (TAC);
    ...
    // Unknown jump to Block ['0x21a0', '0x29fe']. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x25de. Refer to 3-address code (TAC);
    v129 = RETURNDATASIZE();
    // Unknown jump to Block 0x218e0x1f9. Refer to 3-address code (TAC);
    v120 = v134 = 192;
    v118.word0 = 160;
    // Unknown jump to Block 0x35000x1f9. Refer to 3-address code (TAC);
    ...
    require(v79 - v7 >= 32);
    v75 = MEM[v7];
    // Unknown jump to Block ['0x2333', '0x25fc', '0x2785', '0x2b68', '0x3005']. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x1fb4. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x2434. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x2837. Refer to 3-address code (TAC);
    v135 = new uint256[](MEM[96]);
    MCOPY(v135.data, 128, MEM[96]);
    MEM[32 + (MEM[96] + v135)] = 0;
    return v135, MEM[96], address(v136), 160;
    v137 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v37a9_0x1 + 320 - v36e6V0x386a0x3824V0x2bf0], MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v2c26_0x3]).gas(msg.gas);
    if (v137) {
        v75 = v138 = 0;
        if (v137) {
            v77 = v139 = 10117;
    ...
    if (!v7) {
        ...
        if (v144) {
            ...
            v147 = v148 = 32;
            if (v144) {
                // Unknown jump to Block 0x2757. Refer to 3-address code (TAC);
            }
        }
    } else {
        v7 = v149 = v75 >> 128;
        ...
        if (v152) {
            v153 = v154 = 9405;
            if (v152) {
                // Unknown jump to Block 0x2639. Refer to 3-address code (TAC);
            }
        }
    }
    v155 = v156 = address(MEM[v7]);
    // Unknown jump to Block ['0x24bd', '0x28c0']. Refer to 3-address code (TAC);
    require(0x4444c5dc75cb358380d2e3de08a90.code.size);
    ...
    if (int128(v7) != int256.min) {
        v164 = 0 - int128(v7);
        // Unknown jump to Block ['0x1827f', '0x18363']. Refer to 3-address code (TAC);
        v165 = v166 = uint24(v7);
        v167 = _SafeDiv(v7 * v164 * 10000, (v7 - v164) * (10000 - v165));
        // Unknown jump to Block ['0x182a8', '0x1838c']. Refer to 3-address code (TAC);
        v168 = new bytes[](68);
        ...
        if (v178) {
            ...
            if (v180) {
                if (v180) {
                    // Unknown jump to Block 0x25e4. Refer to 3-address code (TAC);
                }
            }
        }
        // Unknown jump to Block 0x47920x1f9. Refer to 3-address code (TAC);
        v165 = v181 = uint24(v7);
        // Unknown jump to Block 0x495b0x1f9. Refer to 3-address code (TAC);
    }
    require(0x4444c5dc75cb358380d2e3de08a90.code.size);
    ...
    if (v185) {
        ...
        if (v191) {
            if (v191) {
                ...
                // Unknown jump to Block 0x216e. Refer to 3-address code (TAC);
            }
        }
    }
    ...
    // Unknown jump to Block ['0x26d4', '0x2add']. Refer to 3-address code (TAC);
    require(0x4444c5dc75cb358380d2e3de08a90.code.size);
    ...
    MEM[64] = v142;
    require(v142 - v142 >= 0);
    v201 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v37a9_0x1 + 320 - v36e6V0x386a0x3824V0x2bf0], MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v2c26_0x3]).gas(msg.gas);
    if (v201) {
        v75 = v202 = 0;
        if (v201) {
            v77 = v203 = 11112;
    ...
    v216 = 0x4444c5dc75cb358380d2e3de08a90.call(MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v37a9_0x1 + 320 - v36e6V0x386a0x3824V0x2bf0], MEM[v36e6V0x386a0x3824V0x2bf0:v36e6V0x386a0x3824V0x2bf0 + v2c26_0x3]).gas(msg.gas);
    if (v216) {
        v75 = v217 = 0;
        if (v216) {
            v77 = v218 = 12293;
    ...
    if (int128(v226) != int128.min) {
        // Unknown jump to Block ['0x18639', '0x1871d']. Refer to 3-address code (TAC);
        ...
        // Unknown jump to Block 0x2d30. Refer to 3-address code (TAC);
    }
    revert(Panic(17));
    v77 = v244 = 9724;
    if (32 <= RETURNDATASIZE()) {
    ...
    if (!v0) {
        ...
        if (!varg4) {
            ...
            if (v39) {
                v11 = v40 = 0;
                if (v39) {
                    // Unknown jump to Block 0x1c60. Refer to 3-address code (TAC);
                }
            }
        } else {
            v8 = v41 = MEM[64];
        ...
        v6 = v52 = 6556;
        v53 = new struct(3);
        v53.word1 = keccak256(MEM[v1971_0x0.word2:v1971_0x0.word2 + 160]);
        v53.word2 = 6;
        v53.word0 = 64;
        require(!((v53 + 96 > uint64.max) | (v53 + 96 < v53)), Panic(65)); // failed memory allocation (too much memory)
        v54 = v53.word0.length;
        v55 = v56 = keccak256(keccak256(MEM[v1971_0x0.word2:v1971_0x0.word2 + 160]), 6);
        v57 = v58 = MEM[64];
        ...
        if (v59) {
            ...
            if (v83) {
                ...
                require(v91 - v81 >= 32);
                v87 = MEM[v81];
                // Unknown jump to Block ['0x10b30x1fe', '0x4cdd0x1fe']. Refer to 3-address code (TAC);
                v93 = this.balance;
                ...
                if (!v50) {
                    ...
                    // Unknown jump to Block ['0x191c50x1fe', '0x192ba0x1fe']. Refer to 3-address code (TAC);
                } else {
                    ...
                    if (this.balance <= v106 / 1000) {
                        MEM[0] = MEM[0];
                        v108 = 0x35aa(v87);
                        0x5151(v108, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                    }
                    if (v106 / 1000) {
                ...
                v1 = v112 = 0x19637;
                v1 = v113 = 0x1967f;
                v114 = v115 = 0x4d16(address(MEM[v6]) * address(MEM[v6]), address(MEM[v6]) * address(MEM[v6]) % uint256.max - address(MEM[v6]) * address(MEM[v6]) - (address(MEM[v6]) * address(MEM[v6]) % uint256.max < address(MEM[v6]) * address(MEM[v6])));
                if (!v1) {
                ...
                if (!v100) {
                    v6 = v122 = 0x4a40(v78.word0, MEM[v6]);
                    v6 = v123 = uint96.max + 1;
                } else {
                    v6 = v124 = 0x4a40(MEM[v6], v78.word0);
                ...
                while (1) {
                    ...
                    if (uint96.max + 1 <= v127) {
                        ...
                        if (v114 * v6 % uint256.max - v126 == v114 * v6 % uint256.max < v126) {
                            v114 = v126 >> 96;
                            // Unknown jump to Block ['0x19637', '0x1967f']. Refer to 3-address code (TAC);
                        } else {
                ...
                if (v114 <= v6) {
                    ...
                    if (bool(MEM[v6])) {
                        ...
                        // Unknown jump to Block 0x1b96. Refer to 3-address code (TAC);
                    } else {
                        v137 = v140 = 0x17b8d;
                        v141 = v142 = 7062;
                ...
                v139 = v157 = v143 / v145;
                // Unknown jump to Block ['0x1a99', '0x1b96']. Refer to 3-address code (TAC);
                MEM[v6] = address(v139);
                // Unknown jump to Block ['0x17b8d', '0x17cc4']. Refer to 3-address code (TAC);
                MEM[v1] = bool(!MEM[v1]);
                ...
                if (bool(v158)) {
                    ...
                    // Unknown jump to Block 0x17b6a. Refer to 3-address code (TAC);
                } else {
                ...
                // Unknown jump to Block 0x17ab7. Refer to 3-address code (TAC);
                MEM[v6] = address(v139);
                // Unknown jump to Block ['0x17907', '0x17a71']. Refer to 3-address code (TAC);
                v185 = v186 = bool(MEM[v1]);
                if (bool(v185)) {
                    MEM[v1] = address(address(MEM[v1]) >> 48);
                    v187 = v188 = bool(MEM[v6]);
                    // Unknown jump to Block 0x178e4. Refer to 3-address code (TAC);
                } else {
                ...
                if (v200) {
                    ...
                    if (v200) {
                        ...
                        require(!((MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) > uint64.max) | (MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) < MEM[64])), Panic(65)); // failed memory allocation (too much memory)
                        MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
                        v202 = 0x3dce(MEM[64], MEM[64] + RETURNDATASIZE());
                    }
                }
                v50 = 0x3ff & v1 >> 50;
                ...
                // Unknown jump to Block 0x1789e. Refer to 3-address code (TAC);
                revert();
            }
            ...
            require(v67 - v57 >= 32);
            v63 = v212 = MEM[v57];
            // Unknown jump to Block ['0x3dabB0x1993', '0x3dc8B0x1993']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x3d84B0x1993. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
        // Unknown jump to Block 0x1918. Refer to 3-address code (TAC);
        v13 = v213 = 7289;
        if (32 <= RETURNDATASIZE()) {
        ...
        // Unknown jump to Block ['0x1c27', '0x1c79', '0x1d04', '0x1d56', '0x1db0', '0x1e02']. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x1916. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x1c5a. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x18d8. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x1d37. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x1d8f. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x18da. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x18dc. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x1d91. Refer to 3-address code (TAC);
    } else {
        exit;
    }
}
...
function 0x6e3aab9b(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, int24 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10) public payable { 
    ...
    if (!v0) {
        ...
        v33 = v34 = 5235;
        v35 = new struct(3);
        v35.word1 = keccak256(MEM[v144d_0x0.word2:v144d_0x0.word2 + 160]);
        v35.word2 = 6;
        v35.word0 = 64;
        require(!((v35 + 96 > uint64.max) | (v35 + 96 < v35)), Panic(65)); // failed memory allocation (too much memory)
        v36 = v35.word0.length;
        v37 = v38 = keccak256(keccak256(MEM[v144d_0x0.word2:v144d_0x0.word2 + 160]), 6);
        v39 = v40 = MEM[64];
        ...
        if (v41) {
            ...
            if (v60) {
                ...
                require(v68 - v58 >= 32);
                v64 = MEM[v58];
                // Unknown jump to Block ['0x10b30x208', '0x4cdd0x208']. Refer to 3-address code (TAC);
                v70 = this.balance;
                ...
                if (!v74) {
                    ...
                    v78 = 0x35e2(msg.gas);
                    require(v78 >= msg.gas, Error(13665));
                    // Unknown jump to Block ['0x191c50x208', '0x192ba0x208']. Refer to 3-address code (TAC);
                } else {
                ...
                v1 = v89 = 0x19302;
                v1 = v90 = 0x19325;
                v91 = v92 = 0x4d16(address(MEM[v5]) * address(MEM[v5]), address(MEM[v5]) * address(MEM[v5]) % uint256.max - address(MEM[v5]) * address(MEM[v5]) - (address(MEM[v5]) * address(MEM[v5]) % uint256.max < address(MEM[v5]) * address(MEM[v5])));
                if (!v74) {
                    v91 = v93 = _SafeDiv(uint192.max + 1, v92);
                }
                if (!v10) {
                    v5 = v94 = 0x4a40(MEM[v1], MEM[v1 + 32]);
                    v95 = address(MEM[v5]);
                } else {
                    v5 = v96 = 0x4a40(MEM[v1 + 32], MEM[v1]);
                ...
                while (1) {
                    ...
                    if (uint96.max + 1 <= v103) {
                        ...
                        if (v91 * v5 % uint256.max - v102 == v91 * v5 % uint256.max < v102) {
                            v91 = v102 >> 96;
                            // Unknown jump to Block ['0x193020x208', '0x193250x208']. Refer to 3-address code (TAC);
                        } else {
                ...
                if (v91 <= v5) {
                    ...
                    if (bool(MEM[v5 + 96])) {
                        ...
                        // Unknown jump to Block 0x162a. Refer to 3-address code (TAC);
                    } else {
                        v113 = v116 = 0x17554;
                        v117 = v118 = 5674;
                ...
                v115 = v133 = v119 / v121;
                // Unknown jump to Block ['0x153b', '0x162a']. Refer to 3-address code (TAC);
                MEM[v5] = address(v115);
                // Unknown jump to Block ['0x17554', '0x17711']. Refer to 3-address code (TAC);
                MEM[v5] = bool(!MEM[v5]);
                ...
                if (!v134) {
                    ...
                    // Unknown jump to Block 0x174a7. Refer to 3-address code (TAC);
                } else {
                    MEM[v5] = bool(!MEM[v5]);
                ...
                // Unknown jump to Block 0x174eb. Refer to 3-address code (TAC);
                MEM[v5] = address(v115);
                // Unknown jump to Block ['0x17346', '0x17482']. Refer to 3-address code (TAC);
                v162 = v163 = bool(MEM[v5]);
                if (!v162) {
                    MEM[v1] = MEM[v1 + 32];
                    MEM[v1 + 32] = MEM[v1];
                    v164 = v165 = bool(MEM[v5]);
                    // Unknown jump to Block 0x172bc. Refer to 3-address code (TAC);
                } else {
                ...
                if (v177) {
                    ...
                    if (v177) {
                        ...
                        require(!((MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) > uint64.max) | (MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) < MEM[64])), Panic(65)); // failed memory allocation (too much memory)
                        MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
                        v179 = 0x3dce(MEM[64], MEM[64] + RETURNDATASIZE());
                    }
                }
                ...
                // Unknown jump to Block 0x17300. Refer to 3-address code (TAC);
                revert();
            }
            ...
            require(v49 - v39 >= 32);
            v45 = v189 = MEM[v39];
            // Unknown jump to Block ['0x3dabB0x144e', '0x3dc8B0x144e']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x3d84B0x144e. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
        ...
        // Unknown jump to Block ['0x173b', '0x178b']. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x13e3. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x13e5. Refer to 3-address code (TAC);
    } else {
        exit;
    }
}
    ...
    if (!v0) {
        ...
        if (!varg4) {
            ...
            if (v39) {
                v11 = v40 = 0;
                if (v39) {
                    // Unknown jump to Block 0x111b. Refer to 3-address code (TAC);
                }
            }
        } else {
            v8 = v41 = MEM[64];
            ...
            if (v42) {
                ...
                if (v42) {
                    ...
                    v45 = v46 = 32;
                    if (32 > RETURNDATASIZE()) {
                        // Unknown jump to Block 0x10e10x212. Refer to 3-address code (TAC);
                    }
                }
            }
        }
        ...
        v1 = v53 = 3475;
        v54 = new struct(3);
        v54.word1 = keccak256(MEM[vd68_0x0.word2:vd68_0x0.word2 + 160]);
        v54.word2 = 6;
        v54.word0 = 64;
        require(!((v54 + 96 > uint64.max) | (v54 + 96 < v54)), Panic(65)); // failed memory allocation (too much memory)
        v55 = v54.word0.length;
        v56 = v57 = keccak256(keccak256(MEM[vd68_0x0.word2:vd68_0x0.word2 + 160]), 6);
        v58 = v59 = MEM[64];
        ...
        if (v60) {
            ...
            if (v82) {
                ...
                v1 = v103 = 0x190f1;
                if (0 == v51) {
                    v1 = v104 = 0x4a40(MEM[v1], MEM[v1]);
                } else {
                    v1 = v105 = 0x4a40(MEM[v1], MEM[v1]);
                }
                while (1) {
                    v106 = address(v1);
                    while (1) {
                        v107 = v106 * v106 % uint256.max - v106 * v106 - (v106 * v106 % uint256.max < v106 * v106);
                        // Unknown jump to Block ['0x190a7', '0x190cc']. Refer to 3-address code (TAC);
                        ...
                        if (v107 == v106 * v106 < ((v107 * uint256.max % (uint96.max + 1) + v107) % (uint96.max + 1) + v106 * v106) % (uint96.max + 1)) {
                            // Unknown jump to Block ['0x40a5', '0x40bb0x212']. Refer to 3-address code (TAC);
                        } else {
                            // Unknown jump to Block ['0x40a5', '0x40bb0x212']. Refer to 3-address code (TAC);
                        }
                        if (!v1) {
                        ...
                        // Unknown jump to Block 0x4d160x212. Refer to 3-address code (TAC);
                    }
                }
                if (!v1) {
                ...
                while (1) {
                    ...
                    if (uint96.max + 1 <= v114 - v113 - (v114 < v113)) {
                        ...
                        if (v114 - v113 == v114 < v113) {
                            v1 = v113 >> 96;
                            // Unknown jump to Block ['0x19084', '0x190f1']. Refer to 3-address code (TAC);
                        } else {
                ...
                if (v179) {
                    ...
                    if (v179) {
                        ...
                        require(!((MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) > uint64.max) | (MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) < MEM[64])), Panic(65)); // failed memory allocation (too much memory)
                        MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
                        v181 = 0x3dce(MEM[64], MEM[64] + RETURNDATASIZE());
                    }
                }
                // Unknown jump to Block 0x4b2f0x212. Refer to 3-address code (TAC);
                revert();
                ...
                require(v90 - v80 >= 32);
                v86 = MEM[v80];
                // Unknown jump to Block ['0x10b30x212', '0x4cdd0x212']. Refer to 3-address code (TAC);
                ...
                if (!v1) {
                    ...
                    // Unknown jump to Block ['0x191c50x212', '0x192ba0x212']. Refer to 3-address code (TAC);
                } else {
                    ...
                    if (this.balance <= v192 / 1000) {
                        MEM[0] = MEM[0];
                        v194 = 0x35aa(v86);
                        0x5151(v194, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                    }
                    if (v192 / 1000) {
            ...
            require(v68 - v58 >= 32);
            v64 = v198 = MEM[v58];
            // Unknown jump to Block ['0x3dabB0xd8a', '0x3dc8B0xd8a']. Refer to 3-address code (TAC);
            // Unknown jump to Block 0x3d84B0xd8a. Refer to 3-address code (TAC);
        }
        revert(MEM[64], RETURNDATASIZE());
        // Unknown jump to Block 0xd0f. Refer to 3-address code (TAC);
        v13 = v199 = 4404;
        if (32 <= RETURNDATASIZE()) {
            require(!((v8 + 32 > uint64.max) | (v8 + 32 < v8)), Panic(65)); // failed memory allocation (too much memory)
            MEM[64] = v8 + 32;
        ...
        // Unknown jump to Block ['0x10db', '0x1134', '0x11bf', '0x1211', '0x126b', '0x12bd']. Refer to 3-address code (TAC);
        // Unknown jump to Block 0xd0d. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x1115. Refer to 3-address code (TAC);
        // Unknown jump to Block 0xccf. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x11f2. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x124a. Refer to 3-address code (TAC);
        // Unknown jump to Block 0xcd1. Refer to 3-address code (TAC);
        // Unknown jump to Block 0xcd3. Refer to 3-address code (TAC);
        // Unknown jump to Block 0x124c. Refer to 3-address code (TAC);
    } else {
        exit;
    }
}
...
function 0x35e2(uint256 varg0) private { 
    require(varg0 <= varg0 + 1000, Panic(17)); // arithmetic overflow or underflow
    return varg0 + 1000;
}

function 0x35f1(uint256 varg0) private { 
...
function 0x36aa(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    require(32 <= varg2);
    require(varg2 <= varg1);
    return varg2 - 32, 32 + varg0;
}

function 0x3804(int128 varg0) private { 
    require(varg0 != int128.min, Panic(17)); // arithmetic overflow or underflow
    return 0 - varg0;
}

function 0x38da(uint256 varg0) private { 
    require(varg0 != int256.min, Panic(17)); // arithmetic overflow or underflow
    return 0 - varg0;
}

function 0x3a9a(uint256 varg0) private { 
    v0 = varg0 >> 224;
    v1 = bool(varg0 >> 148);
    if (v1 - 1) {
        if (v1 - 4) {
...
function 0x3c64(struct(4) varg0) private { 
    v0 = varg0.word2.slot0().gas(msg.gas);
    require(v0);
    return ;
}

function 0x3c82(uint256 varg0) private { 
    v0, /* uint128 */ v1 = varg0.liquidity().gas(msg.gas);
    require((RETURNDATASIZE() > 15) & v0);
    return uint128(v1);
}

function 0x3dce(uint256 varg0, uint256 varg1) private { 
...
function 0x3e45(struct(4) varg0) private { 
...
function 0x4398(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4) private { 
    require(v0 != int256.min, Panic(17)); // arithmetic overflow or underflow
    return 0 - v0, varg2, varg3, varg4, varg0;
}

function 0x4792(address varg0, uint256 varg1) private { 
    v0 = new bytes[](68);
...
function 0x4839(uint256 varg0) private { 
    v0 = new bytes[](68);
    MEM[v0.data] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000;
...
function 0x4a40(uint256 varg0, uint256 varg1) private { 
...
function 0x4d16(uint256 varg0, uint256 varg1) private { 
...
function 0x4d3f(uint256 varg0, uint256 varg1, uint256 varg2) private { 
...
function 0x510b(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = v1 = varg2 > varg0;
    if (varg2 <= varg0) {
        v0 = v2 = varg2 == varg0;
        if (v2) {
