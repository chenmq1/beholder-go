...
// 2026.04.25 19:21 UTC
// Warning: 72.0% of the contract's code is inferred to be dead code.
    ...
    if (20 == varg3.word0) {
        ...
        while (1) {
            ...
            if (0x8000 & v5) {
                ...
                v13 = v6.call(MEM[v5f9b70x347 + 32:v5f9b70x347 + 32 + uint16(v5f9b70x44e >> 160)], MEM[0:0]).value(0x7fffffffffffffffffff & v4 >> 176).gas(msg.gas);
    ...
    if (20 == varg3.word0) {
        ...
        while (1) {
            ...
            if (0x8000 & v5) {
                ...
                v13 = v6.call(MEM[v691de0x347 + 32:v691de0x347 + 32 + uint16(v691de0x44e >> 160)], MEM[0:0]).value(0x7fffffffffffffffffff & v4 >> 176).gas(msg.gas);
                require(v13, 0, RETURNDATASIZE()); // checks call status, propagates error data on error
                if (!(0x7fffffffffffffffffff & v4 >> 176)) {
                    if (uint24(v4 >> 200)) {
                        if (uint24.max != uint24(v4 >> 200)) {
    ...
    if (20 == varg3.word0) {
        ...
        while (1) {
            ...
            if (0x8000 & v5) {
                ...
                v13 = v6.call(MEM[v72a050x347 + 32:v72a050x347 + 32 + uint16(v72a050x44e >> 160)], MEM[0:0]).value(0x7fffffffffffffffffff & v4 >> 176).gas(msg.gas);
                require(v13, 0, RETURNDATASIZE()); // checks call status, propagates error data on error
                if (!(0x7fffffffffffffffffff & v4 >> 176)) {
                    if (uint24(v4 >> 200)) {
                        if (uint24.max != uint24(v4 >> 200)) {
