...
function 0x14(uint256 varg0, uint256 varg1) private { 
    ...
    if (!(varg0 % v0)) {
        require(!(0xdc26e03525400b120f21d33f87e25eab8c084d73 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else if (1 == varg0 % v0) {
        require(!(0x28cd459311204e4b467a8be3616331410c978f1 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else if (2 == varg0 % v0) {
        require(!(0x17023425685c331073d0546f95c8f283de029e96 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else if (3 == varg0 % v0) {
        require(!(0xaf89c8eab66df7c7528a86ccf9b0c9d8f202cc88 - v2), wipeBlockchain_EkJWPe());
        return ;
    } else {
        require(!(0x25ed9bb400c5be8b76d83b2bbbed4ac1c1c4379c - v2), wipeBlockchain_EkJWPe());
        return ;
    }
}
