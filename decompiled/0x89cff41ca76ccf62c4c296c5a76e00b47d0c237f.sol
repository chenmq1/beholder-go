...
function pancakeCall(address _sender, uint256 _amount0, uint256 _amount1, bytes _data) public nonPayable { 
    ...
    v19 = v6.call(MEM[vb9ed0x102_0x0:vb9ed0x102_0x0 + v2ab_0x0 - vb9ed0x102_0x0], MEM[vb9ed0x102_0x0:vb9ed0x102_0x0 + v2ab_0x6]).value(v10).gas(msg.gas);
...
function 0x6d8a1861(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        v8, v9 = 0x155c(varg0);
        v10, v11 = 0x155c(varg1);
        if (v11 * v8 <= v10 * v9) {
            0x1b3c(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v11, v10, v9, v8);
            exit;
        } else {
            0x1b3c(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v9, v8, v11, v10);
            exit;
        }
    } else {
        exit;
...
function 0x4749db78(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        if (0 == v13) {
            0x19e3(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v11, v10, v8, v9);
            exit;
        } else {
            0x1882(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v8, v9, v11, v10);
            exit;
        }
    } else {
        exit;
...
function 0x11f9(uint256 varg0) private { 
...
function 0x17db53bd(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        if (0 == v10) {
            0x1882(v2 + this.balance, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v8, v9, v7, v6);
            exit;
        } else {
            0x19e3(v2 + this.balance, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v7, v6, v8, v9);
            exit;
        }
    } else {
        exit;
...
function 0x1208(uint256 varg0) private { 
...
function 0x1224(uint256 varg0) private { 
...
function 0x155c(address varg0) private { 
...
function 0x1632(uint256 varg0) private { 
    v0, /* uint128 */ v1 = varg0.liquidity().gas(msg.gas);
    require((RETURNDATASIZE() > 15) & v0);
    return uint128(v1);
}

function 0x1683(uint256 varg0) private { 
        ...
        if (v11) {
            ...
            if (!(0x3ff & varg3 >> 50)) {
                ...
                if (this.balance <= v26 / 1000) {
                    v28 = 0x1224(v12);
                    0x29fa(v28, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v26 / 1000) {
...
function 0x19b7(uint256 varg0) private { 
    require(varg0 != int256.min, Panic(17)); // arithmetic overflow or underflow
    return 0 - varg0;
}

function 0x19e3(uint256 varg0, uint256 varg1, address varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10) private { 
        ...
        if (v14) {
            ...
            if (!(0x3ff & varg3 >> 50)) {
                ...
                if (this.balance <= v29 / 1000) {
                    v31 = 0x1224(v15);
                    0x29fa(v31, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v29 / 1000) {
...
function 0x1b3c(uint256 varg0, uint256 varg1, address varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10) private { 
    v0 = _SafeMul(varg7, varg8);
    v1 = 0x23d7(v0);
    ...
    v6 = 0x290f(varg1, varg7, varg8, 10000 - varg4, v5 + 1);
        ...
        if (v9) {
            ...
            if (!(0x3ff & varg3 >> 50)) {
                ...
                if (this.balance <= v24 / 1000) {
                    v26 = 0x1224(v10);
                    0x29fa(v26, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v24 / 1000) {
...
function 0x1c37(address varg0, uint256 varg1) private { 
    v0 = new bytes[](68);
        ...
        if (v12) {
            ...
            if (!(0x3ff & varg3 >> 50)) {
                ...
                if (this.balance <= v27 / 1000) {
                    v29 = 0x1224(v13);
                    0x29fa(v29, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v27 / 1000) {
...
function 0x1e98(uint256 varg0, uint256 varg1, address varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10) private { 
    v0 = _SafeMul(varg7, varg8);
    v1 = 0x23d7(v0);
    v2 = _SafeMul(varg9, varg10);
    v3 = 0x23d7(v2);
    ...
    v7 = 0x290f(varg1, varg7, varg8, 10000 - varg4, v6 + 1);
    require(varg2.code.size);
    v8 = new bytes[](v7.word0);
    MCOPY(v8.data, v7.data, v7.word0);
    v8[v7.word0] = 0;
        ...
        if (v10) {
            ...
            if (!(0x3ff & varg3 >> 50)) {
                ...
                if (this.balance <= v25 / 1000) {
                    v27 = 0x1224(v11);
                    0x29fa(v27, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v25 / 1000) {
        ...
        if (v13) {
            ...
            if (!(0x3ff & varg3 >> 50)) {
                ...
                if (this.balance <= v28 / 1000) {
                    v30 = 0x1224(v14);
                    0x29fa(v30, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
                }
                if (v28 / 1000) {
...
function 0x205c(uint256 varg0, address varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10) private { 
    v0 = _SafeMul(varg9, varg10);
    v1 = 0x23d7(v0);
...
function 0x2275(uint256 varg0, uint256 varg1) private { 
...
function 0x22bb(bytes varg0) private { 
    require(varg0 + varg0.length - varg0 >= 64);
    require(MEM[varg0 + 64] <= uint64.max);
    v0 = 0x2275(varg0 + MEM[varg0 + 64] + 32, varg0 + varg0.length + 32);
    return v0, MEM[varg0.data];
}

function 0x22f5(bytes varg0) private { 
    require(varg0 + varg0.length - varg0 >= 64);
...
function 0x2553(address varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = new struct(5);
    v1 = v0.data;
    v0.word1 = varg1;
    v0.word2 = varg2;
...
function 0x25eb(address varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = new struct(5);
    v1 = v0.data;
    v0.word1 = varg1;
    v0.word2 = varg2;
...
function 0x290f(address varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4) private { 
    v0 = new struct(5);
    v1 = v0.data;
    v0.word1 = varg1;
    v0.word2 = varg2;
...
function 0x297a(address varg0) private { 
    v0 = new struct(4);
    v1 = v0.data;
    v0.word1 = varg0;
    v0.word2 = 64;
...
function 0x29b4(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = v1 = varg2 > varg0;
    if (varg2 <= varg0) {
        v0 = v2 = varg2 == varg0;
        if (v2) {
...
function 0x29fa(uint256 varg0, uint256 varg1) private { 
    v0 = varg1.withdraw(varg0).gas(msg.gas);
    require(v0, 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    return ;
}

function 0x2a3f(uint256 varg0, uint256 varg1, uint256 varg2) private { 
...
function 0xbc70(uint256 varg0, uint256 varg1) private { 
    v0 = new bytes[](68);
    MEM[v0.data] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000;
...
function 0xfdfc9d13(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        if (0 == v13) {
            0x2179(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v11, v10, v8, v9);
            exit;
        } else {
            0x205c(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v8, v9, v11, v10);
            exit;
        }
    } else {
        exit;
...
function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes data) public nonPayable { 
    ...
    if (data.length) {
        ...
        if (v1.length) {
            ...
            v27 = v28 = 0x19b7(amount1Delta);
            v29 = v30 = 1;
            v31 = v32 = 0x1000276a4;
            if (amount0Delta > 0) {
                v27 = v33 = 0x19b7(amount0Delta);
        ...
        0x1c37(msg.sender, amount1Delta);
        exit;
    } else {
        0x1c37(msg.sender, amount0Delta);
        exit;
    }
}
...
function 0xda95afab(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        if (0 == v12) {
            0x205c(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v10, v11, v9, v8);
            exit;
        } else {
            0x2179(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v9, v8, v10, v11);
            exit;
        }
    } else {
        exit;
...
function 0xd7c27bb8(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        v11 = 0x1683(varg1);
        if (v9 <= v11) {
            0x1f3e(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v10, v11, v8, v9);
            exit;
        } else {
            0x1f3e(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v8, v9, v10, v11);
            exit;
        }
    } else {
        exit;
...
function 0xb7bb91ad(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        v10, v11 = 0x155c(varg1);
        if (v11 * v8 >= v10 * v9) {
            0x1e98(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v11, v10, v9, v8);
            exit;
        } else {
            0x1e98(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v9, v8, v11, v10);
            exit;
        }
    } else {
        exit;
...
function 0x9cf82838(uint256 varg0, uint256 varg1, uint256 varg2) public payable { 
    ...
    if (!v0) {
        ...
        v11 = 0x1683(varg1);
        if (v9 >= v11) {
            0x1dc7(v2 + v6, varg1, varg0, varg2, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 128, v10, v11, v8, v9);
            exit;
        } else {
            0x1dc7(v2 + v6, varg0, varg1, varg2, 0xfffff & varg2 >> 88, 0xfffff & varg2 >> 108, 0xfffff & varg2 >> 128, v8, v9, v10, v11);
            exit;
        }
    } else {
        exit;
