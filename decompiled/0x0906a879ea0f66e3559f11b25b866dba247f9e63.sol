...
// 2026.04.09 23:59 UTC
// Compiled using the solidity compiler version 0.8.33


// Data structures and variables inferred from the use of storage instructions
address _delegate; // STORAGE[0x0] bytes 0 to 19
bool _unlockCallback; // STORAGE[0x3] bytes 0 to 0
bool _locked; // STORAGE[0x3] bytes 1 to 1
address _payCallback; // STORAGE[0x1] bytes 0 to 19
address stor_3_2_21; // STORAGE[0x3] bytes 2 to 21
bool ___function_selector__; // STORAGE[0x3] bytes 22 to 22



function 0x11e1(uint256 varg0) private { 
    ...
    while (v0 < varg0.length) {
        ...
        if (address(MEM[32 + varg0[v0]]) - address(0x123456789abcdef123456789abcdef123456789a)) {
            ...
            v4, /* uint256 */ v5 = address(MEM[32 + varg0[v0]]).delegatecall(MEM[MEM[64]:MEM[64] + MEM[MEM[v11e1arg0x0[v137f_0x0]]] + MEM[64] - MEM[64]], MEM[MEM[64]:MEM[64]]).gas(msg.gas);
            if (RETURNDATASIZE() != 0) {
            ...
            v9 = 0x2123(v7 + MEM[v7], 32 + MEM[varg0[v0]] + MEM[MEM[varg0[v0]]]);
            v8.word0 = v9;
...
function 0x138b(uint256 varg0, address varg1, address varg2) private { 
    v0 = v1 = 0;
    while (v0 < 68) {
...
function 0x1563(uint256 varg0, address varg1, address varg2) private { 
    v0 = v1 = 0;
    while (v0 < 68) {
        MEM[v0 + MEM[64]] = MEM[v0 + (MEM[64] + 32)];
        v0 += 32;
...
function 0x2123(uint256 varg0, uint256 varg1) private { 
...
function 0x2168(uint256 varg0, uint256 varg1) private { 
    ...
    while (v4 < v0 + (MEM[v0] << 5) + 32) {
        ...
        v7 = 0x2123(v0 + MEM[v4] + MEM[v0 + MEM[v4] + 32] + 32, varg1);
        v6.word0 = v7;
...
function uniswapV2Call(address sender, uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    ...
    require(msg.sender == _payCallback);
    _payCallback = 1;
    ...
    v1.word2 = v3;
    if (v4.length) {
        v5 = 0x2168(v6.data, v6.data + v6.length);
        0x11e1(v5);
    }
    0x138b(v1.word0, msg.sender, v1.word1);
}
...
function maverickV2AddLiquidityCallback(address tokenA, address tokenB, uint256 amountA, uint256 amountB, bytes data) public nonPayable { 
    ...
    _payCallback = 1;
    if (amountA) {
        0x138b(amountA, msg.sender, tokenA);
    }
    if (amountB) {
        0x138b(amountB, msg.sender, tokenB);
    }
}

function 0x279b(uint256 varg0, uint256 varg1) private { 
...
function onFlashLoan(address initiator, address token, uint256 amount, uint256 fee, bytes data) public nonPayable { 
    ...
    v1.word0 = v2;
    if (v3.length) {
        v4 = 0x2168(v5.data, v5.data + v5.length);
        0x11e1(v4);
    }
    v6 = _SafeAdd(amount, fee);
    0x1563(v6, 0x60744434d6339a6b27d73d9eda62b6f66a0a04fa, 0x6b175474e89094c44da98b954eedeac495271d0f);
...
function onMorphoFlashLoan(uint256 varg0, bytes data) public nonPayable { 
    ...
    0x1563(varg0, 0xbbbbbbbbbb9cc5e90e3b3af64bdaf62c37eeffcb, v1.word1);
}
...
function 0x348660a7(address varg0, bytes varg1) public nonPayable { 
    ...
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
    require(v0, Error(0x535259));
    CALLDATACOPY(v2.data, varg1.data, varg1.length);
    MEM[varg1.length + v2.data] = 0;
    v3, /* uint256 */ v4, /* uint256 */ v5 = varg0.delegatecall(v2.data).gas(msg.gas);
    if (RETURNDATASIZE() == 0) {
        v6 = v7 = 96;
    } else {
        v6 = v8 = new bytes[](RETURNDATASIZE());
    ...
    require(v3, Error(0x444346));
    v9 = new uint256[](MEM[v6]);
    v10 = v11 = 0;
    while (v10 < MEM[v6]) {
        MEM[v10 + v9.data] = MEM[v10 + (v6 + 32)];
        v10 += 32;
    }
    MEM[MEM[v6] + v9.data] = 0;
    return v9;
}
...
function payCallback(uint256 varg0, address varg1, uint256 varg2) public nonPayable { 
    ...
    require(msg.sender == _payCallback);
    _payCallback = 1;
    0x138b(varg2, 0xe0e0e08a6a4b9dc7bd67bcb7aade5cf48157d444, varg1);
}
...
function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes data) public nonPayable { 
    ...
    if (v5.length) {
        v6 = 0x2168(v7.data, v7.data + v7.length);
        0x11e1(v6);
    }
    0x138b(v8, msg.sender, v1.word0);
}
...
function maverickV2SwapCallback(address tokenIn, uint256 amountToPay, uint256 varg2, bytes data) public nonPayable { 
    ...
    0x138b(amountToPay, msg.sender, tokenIn);
}
...
function 0xa84bb687(bytes varg0) public nonPayable { 
    require(msg.data.length - 4 >= 32);
    require(varg0 <= uint64.max);
    require(4 + varg0 + 31 < msg.data.length);
    require(varg0.length <= uint64.max);
...
function locked(uint256 tokenId) public nonPayable { 
    require(msg.data.length - 4 >= 32);
    _locked = 1;
    v0, v1 = _SafeSub(0, msg.data.length, 36, msg.data.length);
    require(v1 + v0 - v1 >= 32);
    require(msg.data[v1] <= uint64.max);
    require(v1 + msg.data[v1] + 31 < v1 + v0);
    require(msg.data[v1 + msg.data[v1]] <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
    v2 = new bytes[](msg.data[v1 + msg.data[v1]]);
    require(!((v2 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + msg.data[v1 + msg.data[v1]]) + 31) < v2) | (v2 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + msg.data[v1 + msg.data[v1]]) + 31) > uint64.max)), Panic(65)); // failed memory allocation (too much memory)
    require(v1 + msg.data[v1] + msg.data[v1 + msg.data[v1]] + 32 <= v1 + v0);
    CALLDATACOPY(v2.data, v1 + msg.data[v1] + 32, msg.data[v1 + msg.data[v1]]);
    v2[msg.data[v1 + msg.data[v1]]] = 0;
    v3 = 0xfa0(v2);
    _locked = 0;
    return MEM[vb37_0x0.data:vb37_0x0.data + vb37_0x0.length];
}
...
function 0xdcb698ab(uint256 varg0, uint256 varg1) public payable { 
    ...
    require(varg1.length <= uint64.max);
    require(4 + varg1 + varg1.length + 32 <= msg.data.length);
    0xb4e(varg1.length, varg1.data, varg0.length, varg0.data);
}
...
function receiveFlashLoan(address[] tokens, uint256[] amounts, uint256[] feeAmounts, bytes userData) public nonPayable { 
    ...
    v17 = 0x2123(v15.data + MEM[v15.data] + v15[MEM[v15.data]], 32 + (v15 + v15.length));
    v16.word0 = v17;
    if (v18.length) {
        v19 = 0x2168(v20.data, v20.data + v20.length);
        0x11e1(v19);
    }
    v21 = v22 = 0;
    while (v21 < v0.length) {
...
function uniswapV3MintCallback(uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    ...
    v1.word1 = data.word2;
    if (amount0) {
        0x138b(amount0, msg.sender, v1.word0);
    }
    if (amount1) {
        0x138b(amount1, msg.sender, v1.word1);
    }
}
...
function 0x4db(uint256 varg0, uint256 varg1) private { 
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
    ...
    v3 = varg1 + msg.data[varg1];
    require(v2 - v3 >= 32);
    v4 = 0x1c1e();
    require(msg.data[v3] <= uint64.max);
    require(v3 + msg.data[v3] + 31 < v2);
    require(msg.data[v3 + msg.data[v3]] <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
    v5 = new uint256[](msg.data[v3 + msg.data[v3]]);
    require(!((v5 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (msg.data[v3 + msg.data[v3]] << 5) + 31) < v5) | (v5 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (msg.data[v3 + msg.data[v3]] << 5) + 31) > uint64.max)), Panic(65)); // failed memory allocation (too much memory)
    v6 = v7 = v5.data;
    require(v3 + msg.data[v3] + (msg.data[v3 + msg.data[v3]] << 5) + 32 <= v2);
    v8 = v9 = v3 + msg.data[v3] + 32;
    while (v8 < v3 + msg.data[v3] + (msg.data[v3 + msg.data[v3]] << 5) + 32) {
        require(msg.data[v8] <= uint64.max);
        require(v2 - (v3 + msg.data[v3] + msg.data[v8] + 32) >= 64);
        v10 = 0x1bf6();
        require(msg.data[v3 + msg.data[v3] + msg.data[v8] + 32] <= uint64.max);
        v11 = v3 + msg.data[v3] + msg.data[v8] + 32 + msg.data[v3 + msg.data[v3] + msg.data[v8] + 32];
        require(v11 + 31 < v2);
        require(msg.data[v11] <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
        v12 = new bytes[](msg.data[v11]);
        require(!((v12 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + msg.data[v11]) + 31) < v12) | (v12 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + msg.data[v11]) + 31) > uint64.max)), Panic(65)); // failed memory allocation (too much memory)
        require(v11 + msg.data[v11] + 32 <= v2);
        CALLDATACOPY(v12.data, v11 + 32, msg.data[v11]);
        v12[msg.data[v11]] = 0;
        v10.word0 = v12;
        require(msg.data[v3 + msg.data[v3] + msg.data[v8] + 32 + 32] == address(msg.data[v3 + msg.data[v3] + msg.data[v8] + 32 + 32]));
        v10.word1 = msg.data[v3 + msg.data[v3] + msg.data[v8] + 32 + 32];
        MEM[v6] = v10;
        v6 += 32;
        v8 += 32;
    }
...
function 0x4ced80a3(uint256 varg0, uint256 varg1, struct(3) varg2) public nonPayable { 
    ...
    if (varg0) {
        0x138b(varg0, msg.sender, v1.word0);
    }
    if (varg1) {
        0x138b(varg1, msg.sender, v1.word1);
    }
}

function pancakeV3MintCallback(uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    require(msg.data.length - 4 >= 96);
    require(data <= uint64.max);
    require(4 + data + 31 < msg.data.length);
    require(msg.data[4 + data] <= uint64.max);
...
function algebraMintCallback(uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    require(msg.data.length - 4 >= 96);
    require(data <= uint64.max);
    require(4 + data + 31 < msg.data.length);
    require(msg.data[4 + data] <= uint64.max);
...
function 0xb4e(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
    ...
    0x11e1(v4.word0);
    v14 = varg1 + varg0;
    require(v14 - varg1 >= 32);
    require(msg.data[varg1] <= uint64.max);
    v15 = varg1 + msg.data[varg1];
    require(v14 - v15 >= 128);
    v16 = new struct(4);
    ...
    v16.word0 = msg.data[v15];
    v16.word1 = msg.data[32 + v15];
    v16.word2 = msg.data[v15 + 64];
    require(msg.data[v15 + 96] <= uint64.max);
    require(v15 + msg.data[v15 + 96] + 31 < v14);
    require(msg.data[v15 + msg.data[v15 + 96]] <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
    v17 = new uint256[](msg.data[v15 + msg.data[v15 + 96]]);
    require(!((v17 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (msg.data[v15 + msg.data[v15 + 96]] << 5) + 31) < v17) | (v17 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (msg.data[v15 + msg.data[v15 + 96]] << 5) + 31) > uint64.max)), Panic(65)); // failed memory allocation (too much memory)
    v18 = v19 = v17.data;
    require(v15 + msg.data[v15 + 96] + (msg.data[v15 + msg.data[v15 + 96]] << 5) + 32 <= v14);
    v20 = v21 = v15 + msg.data[v15 + 96] + 32;
    while (v20 < v15 + msg.data[v15 + 96] + (msg.data[v15 + msg.data[v15 + 96]] << 5) + 32) {
        require(msg.data[v20] <= uint64.max);
        require(v14 - (v15 + msg.data[v15 + 96] + msg.data[v20] + 32) >= 64);
        v22 = 0x1bf6();
        require(msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32] <= uint64.max);
        require(v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32] + 31 < v14);
        v23 = msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32]];
        require(v23 <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
        v24 = new bytes[](v23);
        require(!((v24 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + v23) + 31) < v24) | (v24 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 32 + (0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 & 31 + v23) + 31) > uint64.max)), Panic(65)); // failed memory allocation (too much memory)
        require(v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32] + v23 + 32 <= v14);
        CALLDATACOPY(v24.data, v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32] + 32, v23);
        v24[v23] = 0;
        v22.word0 = v24;
        require(msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + 32] == address(msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + 32]));
        v22.word1 = msg.data[v15 + msg.data[v15 + 96] + msg.data[v20] + 32 + 32];
        MEM[v18] = v22;
        v18 += 32;
        v20 += 32;
    }
    v16.word3 = v17;
    v25, /* uint256 */ v26 = address(v16.word0).balanceOf(this).gas(msg.gas);
    require(bool(v25), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v26 >= v16.word2, Error(0x465442));
    if (v27.length) {
        v28 = v16.word3;
        0x11e1(v16.word3);
        v29, /* uint256 */ v26 = address(v16.word0).balanceOf(this).gas(msg.gas);
        require(bool(v29), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
        require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    }
    if (address(v16.word0) != 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2) {
        v30, /* uint256 */ v26 = 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2.balanceOf(this).gas(msg.gas);
    ...
    if (v16.word1) {
        ...
        v32 = 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2.withdraw(v26).gas(msg.gas);
        require(bool(v32), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
        v33 = block.coinbase.call().value(v26).gas(2300 * !v26);
        require(bool(v33), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
        v26 = v34 = _SafeSub(v26, v26);
    }
    if (v26) {
        0x138b(v26, msg.sender, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
    }
    v35 = v36 = address(v16.word0) != 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2;
    if (address(v16.word0) != 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2) {
        v35 = v37 = v26 > 0;
    }
    if (!v35) {
        ...
        0x138b(v26, msg.sender, v16.word0);
        return ;
    }
}

function 0xfa0(bytes varg0) private { 
    require(msg.sender == _payCallback);
    _payCallback = 1;
    ...
    v1 = 0x2123(varg0.data + MEM[varg0.data] + MEM[varg0.data + MEM[varg0.data] + 32], 32 + (varg0 + varg0.length));
    v0.word1 = v1;
    require(MEM[varg0.data + MEM[varg0.data] + 64] <= uint64.max);
    v2 = 0x2123(varg0.data + MEM[varg0.data] + MEM[varg0.data + MEM[varg0.data] + 64], 32 + (varg0 + varg0.length));
    v0.word2 = v2;
    v3 = v4 = 0;
    while (v3 < v5.length) {
    ...
    if (v13.length) {
        v14 = 0x2168(v15.data, v15.data + v15.length);
        0x11e1(v14);
    }
    require(v9 + MEM[v10] - v9 >= 32);
    require(MEM[v9] <= uint64.max);
    require(v9 + MEM[v10] - (v9 + MEM[v9]) >= 64);
    v16 = 0x1bf6();
    require(MEM[v9 + MEM[v9]] <= uint64.max);
    v17 = 0x2123(v9 + MEM[v9] + MEM[v9 + MEM[v9]], v9 + MEM[v10]);
    v16.word0 = v17;
    require(MEM[v9 + MEM[v9] + 32] <= uint64.max);
    v18 = 0x2123(v9 + MEM[v9] + MEM[v9 + MEM[v9] + 32], v9 + MEM[v10]);
    v16.word1 = v18;
    if (v19.length) {
        v20 = v21 = 0;
        ...
        v24, /* uint256 */ v25 = address(v0.word0).delegatecall(v23.data).gas(msg.gas);
        if (RETURNDATASIZE() != 0) {
            v26 = new bytes[](RETURNDATASIZE());
            v25 = v26.data;
            RETURNDATACOPY(v25, 0, RETURNDATASIZE());
        }
        require(v24, Error(21827));
    }
    v27 = v16.word0;
    return v16.word0;
}
...
function __function_selector__(bytes4 function_selector, uint256 varg1) public payable { 
    ...
    if (msg.data.length < 4) {
        ...
        receive();
    } else if (0x4ced80a3 > function_selector >> 224) {
        if (0x2c8958f6 > function_selector >> 224) {
            if (!(function_selector >> 224)) {
                ...
                return MEM[v4c2_0x0.data:v4c2_0x0.data + v4c2_0x0.length];
            } else if (0x7a1018e == function_selector >> 224) {
                0x07a1018e();
            ...
            require(0x3dd657c5 == function_selector >> 224);
            algebraMintCallback(uint256,uint256,bytes);
        }
    } else if (0xa84bb687 > function_selector >> 224) {
        if (0x4ced80a3 == function_selector >> 224) {
            ...
            require(0x99eee9d0 == function_selector >> 224);
            pancakeV3MintCallback(uint256,uint256,bytes);
        }
    } else if (0xdcb698ab > function_selector >> 224) {
        if (0xa84bb687 == function_selector >> 224) {
            0xa84bb687();
        } else if (0xb45a3c0e == function_selector >> 224) {
            locked(uint256);
        } else {
            require(0xd3487997 == function_selector >> 224);
