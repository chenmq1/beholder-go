...
function 0x106d(uint256 varg0, address varg1, address varg2) private { 
    v0 = v1 = 0;
    while (v0 < 68) {
...
function 0x1245(uint256 varg0, address varg1, address varg2) private { 
    v0 = v1 = 0;
    while (v0 < 68) {
        MEM[v0 + MEM[64]] = MEM[v0 + (MEM[64] + 32)];
        v0 += 32;
...
function 0x1529(bytes varg0) private { 
    ...
    v1 = 0x2160(varg0.data + MEM[varg0.data] + MEM[varg0.data + MEM[varg0.data] + 32], 32 + (varg0 + varg0.length));
    v0.word1 = v1;
    require(MEM[varg0.data + MEM[varg0.data] + 64] <= uint64.max);
    v2 = 0x2160(varg0.data + MEM[varg0.data] + MEM[varg0.data + MEM[varg0.data] + 64], 32 + (varg0 + varg0.length));
    v0.word2 = v2;
    v3 = v4 = 0;
    while (v3 < v5.length) {
    ...
    if (v13.length) {
        v14 = 0x21a5(v15.data, v15.data + v15.length);
        0xec3(v14);
    }
    v16 = 0x27b4(v9, v9 + MEM[v10]);
    if (MEM[v16.word1]) {
        v17 = v18 = 0;
        ...
        v19, /* uint256 */ v20 = address(v0.word0).delegatecall(MEM[MEM[64]:MEM[64] + MEM[v1659_0x0.word1] + MEM[64] - MEM[64]], MEM[MEM[64]:MEM[64]]).gas(msg.gas);
        if (RETURNDATASIZE() != 0) {
...
function uniswapV2Call(address sender, uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    ...
    v1.word2 = v3;
    if (v4.length) {
        v5 = 0x21a5(v6.data, v6.data + v6.length);
        0xec3(v5);
    }
    0x106d(v1.word0, msg.sender, v1.word1);
}
...
function maverickV2AddLiquidityCallback(address tokenA, address tokenB, uint256 amountA, uint256 amountB, bytes data) public nonPayable { 
    ...
    _maverickV2AddLiquidityCallback = 1;
    if (amountA) {
        0x106d(amountA, msg.sender, tokenA);
    }
    if (amountB) {
        0x106d(amountB, msg.sender, tokenB);
    }
}

function 0x2160(uint256 varg0, uint256 varg1) private { 
...
function 0x21a5(uint256 varg0, uint256 varg1) private { 
    ...
    while (v4 < v0 + (MEM[v0] << 5) + 32) {
        ...
        v7 = 0x2160(v0 + MEM[v4] + MEM[v0 + MEM[v4] + 32] + 32, varg1);
        v6.word0 = v7;
...
function pancakeV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes data) public nonPayable { 
    ...
    if (v5.length) {
        v6 = 0x21a5(v7.data, v7.data + v7.length);
        0xec3(v6);
    }
    0x106d(v8, msg.sender, v1.word0);
}
...
function onFlashLoan(address initiator, address token, uint256 amount, uint256 fee, bytes data) public nonPayable { 
    ...
    v1.word0 = v2;
    if (v3.length) {
        v4 = 0x21a5(v5.data, v5.data + v5.length);
        0xec3(v4);
    }
    v6 = _SafeAdd(amount, fee);
    0x1245(v6, 0x60744434d6339a6b27d73d9eda62b6f66a0a04fa, 0x6b175474e89094c44da98b954eedeac495271d0f);
...
function 0x27b4(uint256 varg0, uint256 varg1) private { 
    ...
    v2 = 0x2160(v0 + MEM[v0], varg1);
    v1.word0 = v2;
    require(MEM[v0 + 32] <= uint64.max);
    v3 = 0x2160(v0 + MEM[v0 + 32], varg1);
    v1.word1 = v3;
    return v1;
}
...
function onMorphoFlashLoan(uint256 varg0, bytes data) public nonPayable { 
    ...
    0x1245(varg0, 0xbbbbbbbbbb9cc5e90e3b3af64bdaf62c37eeffcb, v1.word1);
}

function 0x28d5(uint256 varg0, uint256 varg1) private { 
...
function 0x4ced80a3(uint256 varg0, uint256 varg1, struct(3) varg2) public nonPayable { 
    ...
    if (varg0) {
        0x106d(varg0, msg.sender, v1.word0);
    }
    if (varg1) {
        0x106d(varg1, msg.sender, v1.word1);
    }
}
...
function 0x574b48d2(struct(2) varg0) public nonPayable { 
    ...
    if (v17.length) {
        v18 = 0x21a5(v19.data, v19.data + v19.length);
        0xec3(v18);
    }
    v20 = 0x27b4(v13, v13 + MEM[v14]);
    if (MEM[v20.word1]) {
        v21 = v22 = 0;
        ...
        v23, /* uint256 */ v24 = address(v2.word0).delegatecall(MEM[MEM[64]:MEM[64] + MEM[v1477_0x0V0x7c4V0x30e.word1] + MEM[64] - MEM[64]], MEM[MEM[64]:MEM[64]]).gas(msg.gas);
        if (RETURNDATASIZE() != 0) {
...
function 0x599d0714(uint256 varg0, address varg1, uint256 varg2) public nonPayable { 
    ...
    require(msg.sender == _maverickV2AddLiquidityCallback);
    _maverickV2AddLiquidityCallback = 1;
    0x106d(varg2, 0xe0e0e08a6a4b9dc7bd67bcb7aade5cf48157d444, varg1);
}
...
function maverickV2SwapCallback(address tokenIn, uint256 amountToPay, uint256 varg2, bytes data) public nonPayable { 
    ...
    0x106d(amountToPay, msg.sender, tokenIn);
}
...
function unlockCallback(bytes rawData) public nonPayable { 
    ...
    if (MEM[v20.word1]) {
        ...
        MEM[MEM[v20.word1] + MEM[64]] = 0;
        v23, /* uint256 */ v24 = address(v2.word0).delegatecall(MEM[MEM[64]:MEM[64] + MEM[v1477_0x0V0x958.word1] + MEM[64] - MEM[64]], MEM[MEM[64]:MEM[64]]).gas(msg.gas);
        if (RETURNDATASIZE() != 0) {
            v25 = new bytes[](RETURNDATASIZE());
            RETURNDATACOPY(v25.data, 0, RETURNDATASIZE());
        }
...
function locked(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    v1 = 0x1529(v0);
    _locked = 0;
    return MEM[v9b9_0x0 + 32:v9b9_0x0 + 32 + MEM[v9b9_0x0]];
}
...
function 0xdcb698ab(uint256 varg0, uint256 varg1) public payable { 
    ...
    require(varg1.length <= uint64.max);
    require(4 + varg1 + varg1.length + 32 <= msg.data.length);
    0xa11(varg1.length, varg1.data, varg0.length, varg0.data);
}
...
function receiveFlashLoan(address[] tokens, uint256[] amounts, uint256[] feeAmounts, bytes userData) public nonPayable { 
    ...
    v17 = 0x2160(v15.data + MEM[v15.data] + v15[MEM[v15.data]], 32 + (v15 + v15.length));
    v16.word0 = v17;
    if (v18.length) {
        v19 = 0x21a5(v20.data, v20.data + v20.length);
        0xec3(v19);
    }
    v21 = v22 = 0;
    while (1) {
...
function 0x3f9(uint256 varg0, uint256 varg1) private { 
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
...
function 0xa11(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
    ...
    if (v26) {
        0x106d(v26, msg.sender, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
    }
    ...
    if (!v35) {
        ...
        0x106d(v26, msg.sender, v16.word0);
        return ;
    }
}
...
function 0xec3(uint256 varg0) private { 
    ...
    while (v0 < varg0.length) {
        ...
        if (address(MEM[32 + varg0[v0]]) - address(0x123456789abcdef123456789abcdef123456789a)) {
            ...
            v4, /* uint256 */ v5 = address(MEM[32 + varg0[v0]]).delegatecall(MEM[MEM[64]:MEM[64] + MEM[MEM[vec3arg0x0[v1061_0x0]]] + MEM[64] - MEM[64]], MEM[MEM[64]:MEM[64]]).gas(msg.gas);
            if (RETURNDATASIZE() != 0) {
                v6 = new bytes[](RETURNDATASIZE());
                v5 = v6.data;
            ...
            v9 = 0x2160(v7 + MEM[v7], 32 + MEM[varg0[v0]] + MEM[MEM[varg0[v0]]]);
            v8.word0 = v9;
