...
function 0x22222222(uint256 varg0, uint256 varg1) public payable { 
    if (0x480a15f9fdb1757d1db6cedc620772553f496637 - tx.origin) {
        if (0xae0cc0d6e76c2b13451ab90cd13a5fa71a5c59ba - tx.origin) {
            if (0xe836ef5abbcde8c2a22c299f639cc9480aa52219 - tx.origin) {
                if (0x970df0f4bd124df46b1dee31329f7444f9e66b68 - tx.origin) {
                    if (0x834d10cef4e5a75d3edddcbb1c5a94f8094e5713 - tx.origin) {
                        if (tx.origin != 0xa57e3e178e41201b05b4e4aa6dde347fdcd5614e) {
                            if (0x1c5bb001cf26ecb9e4af7fc0656d4fb452019790 - tx.origin) {
                                if (tx.origin != 0x90a6e43c22005745c15df003b70292b53344dcf6) {
                                    if (0xe6618358787976f673187ca24da5f715a0496aa7 - tx.origin) {
                                        if (tx.origin != 0x8a3999c2a419d11635a5146035824a49c33ca211) {
                                            if (tx.origin != 0xd7e1236c08731c3632519dcd1a581bfe6876a3b2) {
                                                if (tx.origin != 0x65fb9db5fc926eb22ac5ae86e74242e0df44718c) {
                                                    if (0xb19c265d240326578eeb346189ebd96ae84949a9 - tx.origin) {
                                                        if (tx.origin != 0xdf8adfe10d4a4d9f0fc4d3e377a6e8d5730eb40c) {
...
function uniswapV2Call(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10, uint256 varg11, uint256 varg12, uint256 varg13, uint256 varg14, uint256 varg15, uint256 varg16, uint256 varg17, uint256 varg18, uint256 varg19) public payable { 
    ...
    if (!(varg2 >> 248)) {
        ...
        if (!(varg6 >> 248)) {
            ...
            v9 = this.delegatecall(MEM[0:v4fc6_0x0V0x36c2], MEM[0:0]).gas(msg.gas);
            require(v9);
        } else if (2 == varg6 >> 248) {
            v10 = v11 = varg7 >> 96;
            v12 = v13 = varg12 >> 248;
        ...
        // Unknown jump to Block ['0x19b0eB0x36c2', '0x19b3eB0x36c2']. Refer to 3-address code (TAC);
        ...
        if (!(varg7 >> 248)) {
            ...
            MEM[v67] = v2;
            v70 = this.delegatecall(MEM[0:v53f1_0x2V0x36c2 + 32], MEM[0:0]).gas(msg.gas);
            require(v70);
        } else if (2 == varg7 >> 248) {
            v10 = v71 = varg8 >> 96;
            v12 = varg13 >> 248;
        ...
        // Unknown jump to Block 0x4fdcB0x36c2. Refer to 3-address code (TAC);
    }
    exit;
    v106 = 0;
    ...
    require(v111);
    // Unknown jump to Block ['0x19aedB0x36c2', '0x19b6eB0x36c2']. Refer to 3-address code (TAC);
    ...
    require(v112);
    // Unknown jump to Block ['0x19aedB0x36c2', '0x19b6eB0x36c2']. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x19940. Refer to 3-address code (TAC);
    v114 = 0;
    ...
    // Unknown jump to Block 0x4e32B0x36c2. Refer to 3-address code (TAC);
    // Unknown jump to Block 0x19940. Refer to 3-address code (TAC);
}
...
function solidlyV3SwapCallback(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9, uint256 varg10, uint256 varg11, uint256 varg12, uint256 varg13, uint256 varg14, uint256 varg15, uint256 varg16, uint256 varg17, uint256 varg18, uint256 varg19, uint256 varg20, uint256 varg21, uint256 varg22, uint256 varg23, uint256 varg24) public payable { 
    ...
    if (!(varg2 >> 248)) {
        ...
        if (!(varg4 >> 248)) {
            ...
            v9 = this.delegatecall(MEM[0:v589f_0x1V0x5957V0x36cd], MEM[0:0]).gas(msg.gas);
            require(v9);
        } else if (2 == varg4 >> 248) {
            v10 = v11 = 166;
            if (varg16 >> 248 == 1) {
        ...
        if (!(varg8 >> 248)) {
            ...
            v186 = this.delegatecall(MEM[0:v589f_0x1V0x594cV0x36cd], MEM[0:0]).gas(msg.gas);
            require(v186);
        } else if (2 == varg8 >> 248) {
            v187 = v188 = 170;
            if (varg20 >> 248 == 1) {
        ...
        if (!(varg8 >> 248)) {
            ...
            v361 = this.delegatecall(MEM[0:v589f_0x1V0x5920V0x36cd], MEM[0:0]).gas(msg.gas);
            require(v361);
        } else if (2 == varg8 >> 248) {
            v362 = v363 = 170;
            if (varg20 >> 248 == 1) {
                    ...
                    if (0x3a1c453c != function_selector >> 224) {
                        if (0x10d1e85c == function_selector >> 224) {
                            ...
                            if (0 == varg1 >> 248) {
                                ...
                                // Unknown jump to Block 0x2eb0. Refer to 3-address code (TAC);
                            } else if (3 == varg1 >> 248) {
                                v2 = v11 = 4;
                                ...
                                if (!v17) {
                                    ...
                                    if (2 == v17) {
                                        ...
                                        if (3 == msg.data[v16 + 20] >> 248) {
                                            ...
                                            v131 = (msg.data[v16] >> 96).call(MEM[v22bc_0x2:v22bc_0x2 + 196 + msg.data[v2de7_0x0] >> 240], MEM[v22bc_0x2:v22bc_0x2 + v22bc_0x2]).value(v126).gas(msg.gas);
                                            require(v131);
                                            v20 = v132 = 1;
                                        } else {
                                            MEM[132] = v126;
                            ...
                            if (function_selector >> 248 == 1) {
                                v482 = v483 = 0;
                                v484 = v485 = v12 + 1;
                                v486 = msg.data[v12] >> 248;
                                if (!v486) {
                                    MEM[0] = MEM[0];
                                    v482 = v487 = 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2;
                                } else if (1 == v486) {
                                    MEM[0] = MEM[0];
                                    v482 = v488 = 0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48;
                                } else if (2 == v486) {
                                    MEM[0] = MEM[0];
                                    v482 = v489 = 0x6b175474e89094c44da98b954eedeac495271d0f;
                                } else if (3 == v486) {
                                    MEM[0] = MEM[0];
                                    v482 = v490 = 0xdac17f958d2ee523a2206206994597c13d831ec7;
                                } else if (4 == v486) {
                                    MEM[0] = MEM[0];
                                    v482 = v491 = 0x2260fac5e5542a773aa44fbcfedf7c193bc2c599;
                                } else if (5 == v486) {
                                    v482 = v492 = msg.data[v485] >> 96;
                                    v484 = v493 = v12 + 21;
                                }
                                v494 = v495 = v484 + 1;
                                v496 = v497 = 0;
                                if (msg.data[v484] >> 248 == 1) {
                                    v496 = v498 = msg.data[v484 + 3] >> (msg.data[v495] >> 248);
                                    v494 = v499 = (msg.data[v484 + 2] >> 248) + v484 + 3;
                                }
                                if (v486) {
                                    v500 = v482.balanceOf(this).gas(msg.gas);
                                    require(v500);
                                    if (0 == msg.data[v494] >> 248) {
                                        ...
                                        v509 = v482.transfer(msg.data[v494 + 1] >> 96, v501).value(v505).gas(msg.gas);
                                        require(v509);
                                ...
                                if (msg.data[v494 + 1] >> 248 == 1) {
                                    v518 = v520 = 22 + v494;
                                    v516 = v521 = msg.data[v519] >> 96;
                                }
                                v522 = msg.data[(msg.data[v518 + 1] >> 248) + v518 + 4] >> (msg.data[(msg.data[v518 + 1] >> 248) + v518 + 2] >> 248);
                                v523 = (msg.data[(msg.data[v518 + 1] >> 248) + v518 + 3] >> 248) + ((msg.data[v518 + 1] >> 248) + v518);
                                v524 = 0x000000000000000000000000c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2.call(0x70a0823100000000000000000000000000000000000000000000000000000000, this, 0x70a0823100000000000000000000000000000000000000000000000000000000).gas(msg.gas);
                                require(v524);
                                v525 = v526 = 0;
                                if (MEM[36] - v496 - 1 > msg.data[v523 + 6] >> (msg.data[v523 + 4] >> 248) == 1) {
                                    v525 = v527 = MEM[36] - v496 - (msg.data[v523 + 6] >> (msg.data[v523 + 4] >> 248)) - (msg.data[v494] >> 248) * (MEM[36] - v496 - (msg.data[v523 + 6] >> (msg.data[v523 + 4] >> 248)) - 1) / 100 - 1;
                                }
                                if (msg.data[v518 + 2] >> (msg.data[v518] >> 248)) {
                                    require(!(uint256.max + (MEM[36] - v496 - (msg.data[(msg.data[v523 + 5] >> 248) + v523 + 2 + 6] >> (msg.data[(msg.data[v523 + 5] >> 248) + v523 + 2 + 4] >> 248)) - (msg.data[v518 + 2] >> (msg.data[v518] >> 248)))));
                                }
                                v528 = v529 = (msg.data[(msg.data[v523 + 5] >> 248) + v523 + 2 + 6] >> (msg.data[(msg.data[v523 + 5] >> 248) + v523 + 2 + 4] >> 248)) + v525;
                                v530 = v531 = uint256.max + (MEM[36] - v496 - v529);
                                if (v531 < 0) {
                                    require(MEM[36] - v496 - 1 >= v522);
                                    v528 = v532 = v522 + (MEM[36] - v496 - v522 - (MEM[36] - v496 - v522 - 1) * (msg.data[v494] >> 248) / 100) - 1;
                                    v530 = v533 = MEM[36] - v496 - v532 - 1;
                                }
                                v534 = 0x000000000000000000000000c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2.call(MEM[36] - v496 - 1, MEM[36] - v496 - 1, MEM[36] - v496 - 1).gas(msg.gas);
                                require(v534);
                                v535 = block.coinbase.call().value(v530).gas(msg.gas);
                                require(v535);
                                v536 = v516.call().value(v528).gas(msg.gas);
                                require(v536);
                                exit;
                            } else {
                                exit;
