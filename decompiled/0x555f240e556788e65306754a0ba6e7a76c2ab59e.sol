...
bool ___function_selector__; // STORAGE[0x3] bytes 2 to 2
address _payCallback; // STORAGE[0x1] bytes 0 to 19



function 0x117e(uint256 varg0) private { 
    ...
    while (v0 < varg0.length) {
        ...
        if (address(MEM[32 + varg0[v0]]) - address(0x123456789abcdef123456789abcdef123456789a)) {
            ...
            v4, /* uint256 */ v5 = address(MEM[32 + varg0[v0]]).delegatecall(MEM[MEM[64]:MEM[64] + MEM[MEM[v117earg0x0[v131c_0x0]]] + MEM[64] - MEM[64]], MEM[MEM[64]:MEM[64]]).gas(msg.gas);
            if (RETURNDATASIZE() != 0) {
            ...
            v9 = 0x20c0(v7 + MEM[v7], 32 + MEM[varg0[v0]] + MEM[MEM[varg0[v0]]]);
            v8.word0 = v9;
...
function 0x1328(uint256 varg0, address varg1, address varg2) private { 
    v0 = v1 = 0;
    while (v0 < 68) {
...
function 0x1500(uint256 varg0, address varg1, address varg2) private { 
    v0 = v1 = 0;
    while (v0 < 68) {
        MEM[v0 + MEM[64]] = MEM[v0 + (MEM[64] + 32)];
        v0 += 32;
...
function 0x20c0(uint256 varg0, uint256 varg1) private { 
...
function 0x2105(uint256 varg0, uint256 varg1) private { 
    ...
    while (v4 < v0 + (MEM[v0] << 5) + 32) {
        ...
        v7 = 0x20c0(v0 + MEM[v4] + MEM[v0 + MEM[v4] + 32] + 32, varg1);
        v6.word0 = v7;
...
function uniswapV2Call(address sender, uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    ...
    v1.word2 = v3;
    if (v4.length) {
        v5 = 0x2105(v6.data, v6.data + v6.length);
        0x117e(v5);
    }
    0x1328(v1.word0, msg.sender, v1.word1);
}
...
function maverickV2AddLiquidityCallback(address tokenA, address tokenB, uint256 amountA, uint256 amountB, bytes data) public nonPayable { 
    ...
    _payCallback = 1;
    if (amountA) {
        0x1328(amountA, msg.sender, tokenA);
    }
    if (amountB) {
        0x1328(amountB, msg.sender, tokenB);
    }
}

function 0x2738(uint256 varg0, uint256 varg1) private { 
...
function onFlashLoan(address initiator, address token, uint256 amount, uint256 fee, bytes data) public nonPayable { 
    ...
    v1.word0 = v2;
    if (v3.length) {
        v4 = 0x2105(v5.data, v5.data + v5.length);
        0x117e(v4);
    }
    v6 = _SafeAdd(amount, fee);
    0x1500(v6, 0x60744434d6339a6b27d73d9eda62b6f66a0a04fa, 0x6b175474e89094c44da98b954eedeac495271d0f);
...
function onMorphoFlashLoan(uint256 varg0, bytes data) public nonPayable { 
    ...
    0x1500(varg0, 0xbbbbbbbbbb9cc5e90e3b3af64bdaf62c37eeffcb, v1.word1);
}
...
function payCallback(uint256 varg0, address varg1, uint256 varg2) public nonPayable { 
    ...
    require(msg.sender == _payCallback);
    _payCallback = 1;
    0x1328(varg2, 0xe0e0e08a6a4b9dc7bd67bcb7aade5cf48157d444, varg1);
}
...
function maverickV2SwapCallback(address tokenIn, uint256 amountToPay, uint256 varg2, bytes data) public nonPayable { 
    ...
    0x1328(amountToPay, msg.sender, tokenIn);
}
...
function uniswapV3MintCallback(uint256 amount0, uint256 amount1, bytes data) public nonPayable { 
    ...
    v1.word1 = data.word2;
    if (amount0) {
        0x1328(amount0, msg.sender, v1.word0);
    }
    if (amount1) {
        0x1328(amount1, msg.sender, v1.word1);
    }
}
...
function locked(uint256 tokenId) public nonPayable { 
    ...
    v3 = 0xf3d(v2);
    _locked = 0;
    return MEM[vad4_0x0.data:vad4_0x0.data + vad4_0x0.length];
}
...
function 0xdcb698ab(uint256 varg0, uint256 varg1) public payable { 
    ...
    require(varg1.length <= uint64.max);
    require(4 + varg1 + varg1.length + 32 <= msg.data.length);
    0xaeb(varg1.length, varg1.data, varg0.length, varg0.data);
}
...
function receiveFlashLoan(address[] tokens, uint256[] amounts, uint256[] feeAmounts, bytes userData) public nonPayable { 
    ...
    v17 = 0x20c0(v15.data + MEM[v15.data] + v15[MEM[v15.data]], 32 + (v15 + v15.length));
    v16.word0 = v17;
    if (v18.length) {
        v19 = 0x2105(v20.data, v20.data + v20.length);
        0x117e(v19);
    }
    v21 = v22 = 0;
    while (v21 < v0.length) {
...
function 0xf93b3d58() public nonPayable { 
    return address(0x40f6c63b68e72ffab11e831b2b04ed90d012bac8);
}
...
function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes data) public nonPayable { 
    ...
    if (v5.length) {
        v6 = 0x2105(v7.data, v7.data + v7.length);
        0x117e(v6);
    }
    0x1328(v8, msg.sender, v1.word0);
}

function 0x4aa(uint256 varg0, uint256 varg1) private { 
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
...
function 0x4ced80a3(uint256 varg0, uint256 varg1, struct(3) varg2) public nonPayable { 
    ...
    if (varg0) {
        0x1328(varg0, msg.sender, v1.word0);
    }
    if (varg1) {
        0x1328(varg1, msg.sender, v1.word1);
    }
}
...
function 0xaeb(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    v0 = v1 = msg.sender == 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1;
    if (msg.sender != 0x1fdc48ba0903bb1ae7c517c9287d88ea236f8e1) {
        v0 = msg.sender == _delegate;
    }
    ...
    if (v26) {
        0x1328(v26, msg.sender, 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2);
    }
    ...
    if (!v35) {
        ...
        0x1328(v26, msg.sender, v16.word0);
        return ;
    }
}

function 0xf3d(bytes varg0) private { 
    require(msg.sender == _payCallback);
    _payCallback = 1;
    ...
    v1 = 0x20c0(varg0.data + MEM[varg0.data] + MEM[varg0.data + MEM[varg0.data] + 32], 32 + (varg0 + varg0.length));
    v0.word1 = v1;
    require(MEM[varg0.data + MEM[varg0.data] + 64] <= uint64.max);
    v2 = 0x20c0(varg0.data + MEM[varg0.data] + MEM[varg0.data + MEM[varg0.data] + 64], 32 + (varg0 + varg0.length));
    v0.word2 = v2;
    v3 = v4 = 0;
    while (v3 < v5.length) {
    ...
    if (v13.length) {
        v14 = 0x2105(v15.data, v15.data + v15.length);
        0x117e(v14);
    }
    ...
    v17 = 0x20c0(v9 + MEM[v9] + MEM[v9 + MEM[v9]], v9 + MEM[v10]);
    v16.word0 = v17;
    require(MEM[v9 + MEM[v9] + 32] <= uint64.max);
    v18 = 0x20c0(v9 + MEM[v9] + MEM[v9 + MEM[v9] + 32], v9 + MEM[v10]);
    v16.word1 = v18;
    if (v19.length) {
        v20 = v21 = 0;
    ...
    if (msg.data.length < 4) {
        ...
        if (0x2c8958f6 > function_selector >> 224) {
            if (!(function_selector >> 224)) {
                ...
                return MEM[v492_0x0.data:v492_0x0.data + v492_0x0.length];
        ...
        } else if (0x3dd657c5 == function_selector >> 224) {
            algebraMintCallback(uint256,uint256,bytes);
        } else {
            require(0x4ced80a3 == function_selector >> 224);
            0x4ced80a3();
        }
        ...
        if (0x599d0714 == function_selector >> 224) {
            ...
            require(0xa84bb687 == function_selector >> 224);
            0xa84bb687();
        }
    } else if (0xb45a3c0e == function_selector >> 224) {
        locked(uint256);
