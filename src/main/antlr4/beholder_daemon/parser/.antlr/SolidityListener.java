...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#customStorageLayout}.
	 * @param ctx the parse tree
	 */
	void enterCustomStorageLayout(SolidityParser.CustomStorageLayoutContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#customStorageLayout}.
	 * @param ctx the parse tree
	 */
	void exitCustomStorageLayout(SolidityParser.CustomStorageLayoutContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterUsingForObject(SolidityParser.UsingForObjectContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#usingForObject}.
	 * @param ctx the parse tree
	 */
	void exitUsingForObject(SolidityParser.UsingForObjectContext ctx);
	/**
	 * Enter a parse tree produced by {@link SolidityParser#usingForObjectDirective}.
	 * @param ctx the parse tree
	 */
	void enterUsingForObjectDirective(SolidityParser.UsingForObjectDirectiveContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#usingForObjectDirective}.
	 * @param ctx the parse tree
	 */
	void exitUsingForObjectDirective(SolidityParser.UsingForObjectDirectiveContext ctx);
	/**
	 * Enter a parse tree produced by {@link SolidityParser#userDefinableOperators}.
	 * @param ctx the parse tree
	 */
	void enterUserDefinableOperators(SolidityParser.UserDefinableOperatorsContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#userDefinableOperators}.
	 * @param ctx the parse tree
	 */
	void exitUserDefinableOperators(SolidityParser.UserDefinableOperatorsContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterMappingKeyName(SolidityParser.MappingKeyNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#mappingKeyName}.
	 * @param ctx the parse tree
	 */
	void exitMappingKeyName(SolidityParser.MappingKeyNameContext ctx);
	/**
	 * Enter a parse tree produced by {@link SolidityParser#mappingValueName}.
	 * @param ctx the parse tree
	 */
	void enterMappingValueName(SolidityParser.MappingValueNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#mappingValueName}.
	 * @param ctx the parse tree
	 */
	void exitMappingValueName(SolidityParser.MappingValueNameContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterInlineAssemblyStatementFlag(SolidityParser.InlineAssemblyStatementFlagContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#inlineAssemblyStatementFlag}.
	 * @param ctx the parse tree
	 */
	void exitInlineAssemblyStatementFlag(SolidityParser.InlineAssemblyStatementFlagContext ctx);
	/**
