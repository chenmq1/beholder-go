...
// SwapV3Event Uniswap V3 Swap(address indexed sender, address indexed recipient,
// int256 amount0, int256 amount1, uint160 sqrtPriceX96, uint128 liquidity, int24 tick) 事件实体
//
...
// TableName 设置表名
func (SwapV3Event) TableName() string {
	return "swap_v3_event"
}

// 建表语句：
//
// CREATE TABLE IF NOT EXISTS swap_v3_event (
